...
class ViewProject extends Component
{
    ...
    public $edit = false;
    public $isEmpty = true;
    public $projectDeleteModal = false;
    ...
    public function rules()
    {
        return [
            'project_num' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    $exists = DB::table('implementations')
                        ...
                        ->whereNotIn('id', [decrypt($this->passedId)])
                        ->exists();
            ...
            'budget_amount' => [
                ...
                function ($attribute, $value, $fail) {
                    $this->money = new MoneyFormat();
                    // dump($value);
                    $number = $this->money->isMaskInt($value);
                ...
                function ($attribute, $value, $fail) {
                    $this->money = new MoneyFormat();
                    $negative = $this->money->isNegative($value);
    ...
    {
        $implementation = Implementation::find(decrypt($this->passedId));
    ...
    {
        $query = Batch::where('implementations_id', decrypt($this->passedId))
            ->exists();
    ...
    public function saveProject()
    {
        ...
        $this->money = new MoneyFormat();
        $this->budget_amount = $this->money->unmask($this->budget_amount);

        Implementation::where('id', decrypt($this->passedId))
    ...
    {
        $project = Implementation::find(decrypt($this->passedId));
    ...
    public function toggleTry()
    {
        ...
        if ($this->isAutoComputeEnabled) {
            ...
            $this->money = new MoneyFormat();
            $tempBudget = $this->money->unmask($this->budget_amount);
    ...
    public function toggleEdit()
    {
        ...
        if ($this->edit) {
            ...
            $this->budget_amount = $this->money->mask($this->implementation->budget_amount);
