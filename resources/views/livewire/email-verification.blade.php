    ...
    <div class="flex justify-center items-center text-center bg-indigo-100 rounded-2xl sm:max-w-2xl sm:w-full">
        ...
        <div class="relative flex flex-col items-center gap-4 size-full text-indigo-1100 px-6 py-10">
            ...
            <div class="flex flex-col justify-center">
                <span class="text-lg font-medium">An email is sent to <strong
                        class="text-indigo-700">{{ $this->maskedEmail }}</strong></span>
                <span class="text-sm">Please check your email inbox for verification.</span>
            </div>

            {{-- Resend --}}
            <div class="text-xs font-medium text-gray-600 relative flex flex-1 items-center justify-center mb-2">
                <span class="relative flex items-center justify-center">Didn't receive any email?
                    {{-- Resend Button --}}
                    ...
                    <svg class="ms-2 absolute left-full text-indigo-900 size-4 animate-spin" wire:loading
                        wire:target="resendEmail" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
