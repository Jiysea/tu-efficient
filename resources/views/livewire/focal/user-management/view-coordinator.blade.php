                ...
                <div class="flex items-center justify-between py-2 px-4 rounded-t-md">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <button type="button"
                            ...
                            @click="viewCoordinatorModal = false;">
                    ...
                    <div class="whitespace-nowrap grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 text-xs">
                        ...
                        @if (!$editMode)
                            ...
                            <div class="relative flex flex-col">
                                ...
                                <span
                                    class="flex flex-1 text-sm rounded p-2.5 bg-indigo-50 text-indigo-700 font-medium">{{ ucwords($this->user?->first_name) }}</span>
                            </div>
                            ...
                            <div class="relative flex flex-col">
                                ...
                                <span
                                    class="flex flex-1 text-sm rounded p-2.5 bg-indigo-50 text-indigo-700 font-medium">{{ $this->user?->middle_name ? ucwords($this->user?->middle_name) : '-' }}</span>
                            </div>
                            ...
                            <div class="relative flex flex-col">
                                ...
                                <span
                                    class="flex flex-1 text-sm rounded p-2.5 bg-indigo-50 text-indigo-700 font-medium">{{ ucwords($this->user?->last_name) }}</span>
                            </div>
                            ...
                            <div class="relative flex flex-col">
                                ...
                                <span
                                    class="flex flex-1 text-sm rounded p-2.5 bg-indigo-50 text-indigo-700 font-medium">{{ $this->user?->extension_name ? ucwords($this->user?->extension_name) : '-' }}</span>
                            </div>
