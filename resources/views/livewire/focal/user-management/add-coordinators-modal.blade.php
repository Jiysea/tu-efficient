<div wire:ignore.self id="add-coordinators-modal" tabindex="-1" aria-hidden="true"
    ...
    <div x-data="{
        init() {
            window.addEventListener('add-new-coordinator', () => {
                const modal = FlowbiteInstances.getInstance('Modal', 'add-coordinators-modal');
                modal.hide();
            });
        },
    }" class="relative p-4 w-full max-w-6xl max-h-full">
        <!-- Modal content -->
            ...
            <form wire:submit.prevent="saveUser" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-8 text-xs">
                    ...
                    <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                        ...
                        <input type="password" id="password" autocomplete="off" wire:model.live="password"
                    ...
                    {{-- Confirm Password --}}
                    <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                        <label for="password_confirmation" class="block mb-1  font-medium text-indigo-1100 ">Confirm
                            Password</label>
                ...
                <div class="w-full flex relative items-center justify-end">
                    {{-- Loading State for Changes --}}
                    <div class="z-50 text-indigo-900" wire:loading wire:target="saveUser">
                        <svg class="size-6 mr-3 -ml-1 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                stroke-width="4">
