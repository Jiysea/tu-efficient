                ...
                <form wire:submit.prevent="saveUser" class="p-4 md:p-5">
                    ...
                    <div class="w-full flex relative items-center justify-end">
                        ...
                        <button type="submit" wire:loading.attr="disabled" wire:target="saveUser"
                            class="gap-2 py-2 px-4 text-sm text-center font-bold flex items-center text-indigo-50 bg-indigo-700 disabled:opacity-75 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 rounded">
