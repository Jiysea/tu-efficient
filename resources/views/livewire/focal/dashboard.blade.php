...
<div x-data="{ open: true, caretRotate: 0, isAboveBreakpoint: true }" x-init="isAboveBreakpoint = window.matchMedia('(min-width: 1280px)').matches;
window.matchMedia('(min-width: 1280px)').addEventListener('change', event => {
    ...
    <div :class="{
        ...
        <div class="p-2 min-h-screen select-none">
            ...
            <div class="relative flex items-center h-[6vh] my-2">
            ...
            {{-- Body --}}
            <div class="grid lg:grid-cols-3 gap-2 h-full">

                {{-- Project Counters --}}
                <div class="grid gap-2 lg:grid-cols-3 col-span-full">
                    <a href="{{ route('focal.implementations') }}" wire:loading.attr="disabled"
                        class="relative flex items-center justify-start h-[10vh] lg:h-[15vh] rounded bg-white">
                ...
                {{-- Left Side --}}
                <div class="flex flex-col gap-2 h-full lg:col-span-2">

                    {{-- Summary of Beneficiaries Dropdown --}}
                    <div class="flex items-center justify-between w-full h-[6vh]">
                        <h1 class="text-xl font-bold ms-3">Summary of Beneficiaries
                        </h1>

                        <div x-data="{ show: false }" class="relative w-52 z-20">
                            {{-- Dropdown Button --}}
                            <div @click="show = !show;"
                    ...
                    {{-- Per Implementation | Donut Charts --}}
                    <div class="relative w-full bg-white rounded p-3">
                            ...
                            <div class="flex justify-center items-center">
                                ...
                                <div data-popover id="chart-info" role="tooltip"
                                    ...
                                    <div class="p-3 space-y-2">
                                        <h3 class="font-semibold text-gray-900 ">Per Implementation (Male and
                                            Female)
                                        </h3>
                        ...
                        <div class="grid grid-cols-3 place-items-center place-content-center">
                            <div class="relative">
                                @if (
                                    (is_null($this->implementationCount->total_male) && is_null($this->implementationCount->total_female)) ||
                                        (intval($this->implementationCount->total_male) === 0 &&
                                            intval($this->implementationCount->total_female) === 0))
                                    <div
                            ...
                            <div class="relative">
                                @if (
                                    (is_null($this->implementationCount->total_pwd_male) && is_null($this->implementationCount->total_pwd_female)) ||
                                        (intval($this->implementationCount->total_pwd_male) === 0 &&
                                            intval($this->implementationCount->total_pwd_female) === 0))
                                    <div
                                        class="bg-white absolute z-10 min-h-full min-w-full flex flex-col items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="size-12 sm:size-20 mb-4 text-gray-300"
                                        ...
                                        <h2 class="text-gray-500 text-xs sm:text-sm font-medium text-center">
                                            Not enough data <br> for PWD values.
                                        </h2>
                                    </div>
                                @endif
                            ...
                            <div class="relative">
                                @if (
                                    (is_null($this->implementationCount->total_senior_male) &&
                                        is_null($this->implementationCount->total_senior_female)) ||
                                        (intval($this->implementationCount->total_senior_male) === 0 &&
                                            intval($this->implementationCount->total_senior_female) === 0))
                                    <div
                                        class="bg-white absolute z-10 min-h-full min-w-full flex flex-col items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="size-12 sm:size-20 mb-4 text-gray-300"
                                        ...
                                        <h2 class="text-gray-500 text-xs sm:text-sm font-medium text-center">
                                            Not enough data for <br> senior citizen values.
                                        </h2>
                                    </div>
                                @endif
                    ...
                    {{-- Total Counts | Print && Export --}}
                    <div class="grid grid-cols-2 gap-x-2 w-full h-[20vh]">

                        {{-- Total Counts --}}
                        <div class="flex items-center justify-center rounded bg-white">
                ...
                {{-- Right Side --}}
                <div class="col-span-1 flex flex-col h-full rounded justify-between bg-white">
                    ...
                    <div>
                        ...
                        @if ($this->batchesCount !== 0)
                            ...
                            @endforeach
                        @else
                            <div class="bg-white z-10 h-full flex flex-col items-center justify-center">
