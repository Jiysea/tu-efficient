            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-col gap-2 w-full">
                    ...
                    <div class="flex flex-col lg:flex-row gap-2 w-full">
                        ...
                        {{-- Total Projects --}}
                        <span class="relative flex flex-1" x-data="{ tooltip: false }">
                            <a href="{{ route('focal.implementations') }}" @mouseleave="tooltip = false;"
                                @mouseenter="tooltip = true;" wire:loading.attr="disabled"
                                class="bg-white text-indigo-700 relative flex flex-1 items-center justify-start rounded shadow py-2 h-full">
                                <svg class="size-5 m-1.5" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div x-cloak x-show="tooltip" x-transition.opacity
                                class="text-left absolute z-50 top-full left-0 w-64 mt-2 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                This is the total number of <span class="text-indigo-400">projects</span> that are
                                listed
                                based on the <span class="text-indigo-400">date range</span>.
                            </div>
                        </span>
                        ...
                        <span class="relative flex flex-1" x-data="{ tooltip: false }">
                            ...
                            <div x-cloak x-show="tooltip" x-transition.opacity
                                class="text-left absolute z-50 top-full left-0 w-64 mt-2 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                <span class="text-indigo-400">Pending projects</span> are the projects that were
                                recently created
                                where you could assign and modify batches, add beneficiaries
                                on the batches, and modify the batches.
                            </div>
                        </span>
                        ...
                        <span class="relative flex flex-1" x-data="{ tooltip: false }">
                            ...
                            {{-- Tooltip Content --}}
                            <div x-cloak x-show="tooltip" x-transition.opacity
                                class="text-left absolute z-50 top-full right-0 mt-2 w-64 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                <span class="text-indigo-400">Implementing projects</span> is a status where you could
                                mark
                                beneficiaries who signed their Contract of Service
                                and claimed their payroll. However, users would not
                                be able to modify batches, add beneficiaries on the batches,
                                and modify the batches. It also needs <span class="text-indigo-400">all
                                    batches</span>
                                to be on <span class="text-green-400">approved</span> status.
                            </div>
                        </span>
                        ...
                        <span class="relative flex flex-1" x-data="{ tooltip: false }">
                            ...
                            {{-- Tooltip Content --}}
                            <div x-cloak x-show="tooltip" x-transition.opacity
                                class="text-left absolute z-50 top-full right-0 md:right-0 w-64 mt-2 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                <span class="text-indigo-400">Concluded projects</span>
                                is a status where the project
                                and its contents can no longer be modified and will
                                only serve as read-only.
                            </div>
                        </span>
                    </div>
                    ...
                    <div class="flex flex-col lg:flex-row gap-2 w-full lg:justify-between">
                        <div class="flex flex-1 gap-2">
                            ...
                            <span class="relative flex flex-1" x-data="{ tooltip: false }">
                                ...
                                {{-- Tooltip Content --}}
                                <div x-cloak x-show="tooltip" x-transition.opacity
                                    class="text-left absolute z-50 top-full left-0 mt-2 w-64 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                    It is a status where a batch has passed the approval
                                    and finished validating its beneficiaries typically
                                    set by coordinators. It also means that it is ready
                                    for <span class="text-indigo-400">implementing</span>.
                                </div>
                            </span>
                            ...
                            <span class="relative flex flex-1" x-data="{ tooltip: false }">
                                ...
                                {{-- Tooltip Content --}}
                                <div x-cloak x-show="tooltip" x-transition.opacity
                                    class="text-left absolute z-50 top-full right-0 md:left-0 mt-2 w-64 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                    It is a status where a batch is currently ongoing
                                    for encoding, validating, or opened for access to
                                    partnered users like the <span class="text-indigo-400">Barangay users</span>.
                                </div>
                            </span>
                        </div>
                        ...
                        <div class="flex flex-1 gap-2">
                            ...
                            <span class="relative flex flex-1" x-data="{ tooltip: false }">
                                ...
                                <div x-cloak x-show="tooltip" x-transition.opacity
                                    class="text-left absolute z-50 top-full left-0 mt-2 w-64 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                    It is a status where a batch has been submitted from
                                    the partnered users that gained access from coordinators.
                                </div>
                            </span>
                            ...
                            <span class="relative flex flex-1" x-data="{ tooltip: false }">
                                ...
                                <div x-cloak x-show="tooltip" x-transition.opacity
                                    class="text-left absolute z-50 top-full right-0 md:left-0 mt-2 w-64 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                    It is a status where a batch has been recently assigned
                                    and it has not been opened or accessed and it has no content yet.
                                </div>
                            </span>
                        </div>
                        ...
                        <div class="flex flex-1 gap-2">
                            ...
                            <span class="relative flex flex-1" x-data="{ tooltip: false }">
                                ...
                                <div x-cloak x-show="tooltip" x-transition.opacity
                                    class="text-left absolute z-50 top-full left-0 mt-2 w-64 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                    It is a status where a batch is opened for access to
                                    partnered users and they can add and modify beneficiaries.
                                </div>
                            </span>
                            ...
                            <span class="relative flex flex-1" x-data="{ tooltip: false }">
                                ...
                                <div x-cloak x-show="tooltip" x-transition.opacity
                                    class="text-left absolute z-50 top-full right-0 mt-2 w-64 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                    It is a status where a batch is reopened for access
                                    to partnered users for revalidation of the beneficiaries
                                    specifically for replacement or modifications.
                                </div>
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="flex gap-3 w-full lg:h-[30%] text-xs sm:text-sm">
                            ...
                            <div class="flex flex-col gap-3 p-3 w-[40%] rounded shadow bg-white">
                                <div x-data="{ tooltip: false }"
                                    class="relative flex flex-1 items-center justify-between bg-indigo-50 rounded px-2"
                                    ...
                                    {{-- Tooltip Content --}}
                                    <div x-cloak x-show="tooltip" x-transition.opacity
                                        class="text-left absolute z-50 bottom-full right-0 md:right-0 w-64 mb-2 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                        The total number of marked beneficiaries who signed the
                                        <span class="text-indigo-400">Contract of Service (COS)</span>
                                        based on the <span class="text-indigo-400">date range</span>.
                                    </div>
                                </div>
                                ...
                                <div x-data="{ tooltip: false }"
                                    ...
                                    <div x-cloak x-show="tooltip" x-transition.opacity
                                        class="text-left absolute z-50 bottom-full right-0 md:right-0 w-64 mb-2 rounded p-2 shadow text-xs font-normal border bg-zinc-900 border-zinc-300 text-zinc-50">
                                        The total number of marked beneficiaries who signed and
                                        claimed their <span class="text-indigo-400">payroll</span>
                                        based on the <span class="text-indigo-400">date range</span>.
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="flex flex-col gap-1">
                                                        ...
                                                        <div class="relative">
                                                            ...
                                                            <input type="text" readonly id="selected-start-date"
                                                                ...
                                                                name="start" value="{{ $defaultExportStart }}"
                                                                class="cursor-pointer selection:bg-white bg-white border border-indigo-300 text-xs text-indigo-1100 rounded focus:ring-indigo-500 focus:border-indigo-500 w-28 sm:w-32 py-1.5 ps-7 sm:ps-8"
                                                                placeholder="Select date start">
                                                        </div>
                                                    </div>
