<div wire:ignore.self id="create-modal" tabindex="-1" data-modal-backdrop="static" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-2 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        <div class="relative bg-white rounded-md shadow">
            ...
            <div class="flex items-center justify-between py-2 px-4 rounded-t-md">
                ...
                <div class="flex items-center justify-center">
                    ...
                    <button type="button" @click="trapCreate=false" class="text-indigo-400 bg-transparent hover:bg-indigo-200 hover:text-indigo-900 rounded  w-8 h-8 ms-auto inline-flex justify-center items-center focus:outline-none duration-300 ease-in-out" data-modal-toggle="create-modal">
            ...
            <form wire:submit.prevent="saveProject" class="p-4 md:p-5">
                <div class="grid gap-4 mb-4 grid-cols-5 text-xs">
                    ...
                    {{-- Budget --}}
                    <div class="relative col-span-5 sm:col-span-2 mb-4">
                        <label for="budget_amount" class="block mb-1 font-medium text-indigo-1100 ">Budget <span class="text-red-700 font-normal text-xs">*</span></label>
                        <div class="relative">
                            ...
                            <input x-mask:dynamic="$money($input)" type="text" min="0" autocomplete="off" id="budget_amount" @blur="$wire.toggleTry(); $wire.set('budget_amount', $el.value)" class="text-xs duration-200 {{ $errors->has('budget_amount') ? 'border-red-500 border bg-red-200 focus:ring-red-500 focus:border-red-300 focus:ring-offset-red-100 text-red-900 placeholder-red-600' : 'bg-indigo-50 border-indigo-300 text-indigo-1100 focus:ring-indigo-600 focus:border-indigo-600' }} ps-11 border rounded block w-full pe-2.5 py-2.5" placeholder="Type total budget">
                        </div>
                        @error('budget_amount')
                        ...
                        <div class="flex items-center">
                            ...
                            <div tabindex="-1" class="w-full mb-1 flex items-center justify-end">
                                <label class="inline-flex items-center cursor-pointer">
                                    <span class="me-2 text-xs {{ $isAutoComputeEnabled ? 'text-indigo-900' : 'text-gray-500' }} duration-150 ease-in-out">Auto
                ...
                <div class="w-full flex relative items-center justify-end">
                    ...
                    <button type="submit" wire:loading.attr="disabled" wire:target="saveProject" class="space-x-2 py-2 px-4 text-center text-white font-bold flex items-center bg-indigo-700 disabled:opacity-75 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 rounded-md">
                        <p>CREATE NEW PROJECT</p>
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-7" xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400" viewBox="0, 0, 400,400">
                            <g>
