<div x-cloak class="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto backdrop-blur-sm z-auto"
    x-show="viewCredentialsModal" x-trap.noscroll="viewCredentialsModal">
        ...
        <div class="relative size-full max-w-4xl">
            <div x-data="{ viewImageModal: $wire.entangle('viewImageModal') }" class="relative bg-white rounded-md shadow">
                ...
                @if ($passedCredentialId)
                    ...
                    <div x-cloak>
                        <!-- Modal Backdrop -->
                        <div class="fixed inset-0 bg-black bg-opacity-90 backdrop-blur-sm z-50"
