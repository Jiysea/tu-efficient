                        ...
                        @if ($editMode)
                            ...
                            <div class="flex flex-1 flex-col relative">
                                ...
                                @else
                                    ...
                                    <span
                                        class="flex flex-1 text-sm rounded p-2.5 bg-indigo-50 text-indigo-700 font-medium">₱
                                        {{ $this->implementation ? number_format($this->implementation->budget_amount / 100, 2, '.', ',') : null }}</span>
                                @endif
                            </div>
                            ...
                            <div class="flex flex-1 flex-col relative">
                                ...
                                @else
                                    ...
                                    <span
                                        class="flex flex-1 text-sm rounded p-2.5 bg-indigo-50 text-indigo-700 font-medium">₱
                                        {{ $this->implementation ? number_format($this->implementation->minimum_wage / 100, 2, '.', ',') : null }}</span>
                                @endif
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-1 items-center justify-center">
                                    ...
                                    <span
                                        ...
                                        {{ $this->implementation ? date('M d, Y @ h:i:s a', strtotime($this->implementation->created_at)) : null }}</span>
                                </div>
