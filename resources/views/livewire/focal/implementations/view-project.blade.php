<div x-cloak>
    ...
    <!-- Modal -->
    <div x-show="openProjectModal" x-trap.noscroll="openProjectModal"
                ...
                <form wire:submit.prevent="saveProject">
                    ...
                    <div class="flex items-center justify-between py-2 px-4 rounded-t-md">
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <button type="button" @click="$wire.resetEverything(); openProjectModal = false;"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4">
                                ...
                                <span class="col-span-full flex items-center justify-between">
                                    ...
                                    @else
                                        <h2 class="text-sm font-semibold">
                                            Project Number:
                                            <span
                                                class="ms-2 text-sm font-semibold text-indigo-700 bg-indigo-50 px-2 py-2.5 rounded">{{ $this->implementation->project_num }}</span>
                                        </h2>
                                        ...
                                        <div x-data="{ projectDeleteModal: $wire.entangle('projectDeleteModal') }" class="flex justify-center items-center">
                                            ...
                                            {{-- Delete/Trash Button --}}
                                            <button type="button"
                                                @if ($isEmpty) @click="projectDeleteModal = !projectDeleteModal;" @else disabled @endif
                                        ...
                                        @if ($isEmpty)
                                            ...
                                            <div class="relative">
                                                ...
                                                <input x-mask:dynamic="$money($input)" type="text" min="0"
                                                    @blur="$wire.toggleTry();" autocomplete="off" id="budget_amount"
                                                ...
                                                <div tabindex="-1" class="w-full mb-1 flex items-center justify-end">
                                                    <label class="inline-flex items-center cursor-pointer">
                                                        ...
                                                        <input type="checkbox" id="auto-compute"
                                                            wire:click="toggleTry" autocomplete="off"
                                    ...
                                    @if ($edit)
                                        @if ($isEmpty)
                                            ...
                                            <input type="number" min="0" max="15" id="days_of_work"
                                                wire:model.blur="days_of_work" @blur="$wire.toggleTry()"
                                ...
                                @if ($edit)
                                    <div
                                        ...
                                        <div class="flex items-center justify-center">
                                            <button type="submit" wire:click="$parent.editImplementation();"
