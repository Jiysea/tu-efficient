<div x-cloak x-show="viewBeneficiaryModal" class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm z-50">
    ...
    <div x-show="viewBeneficiaryModal" x-trap.noscroll.noautofocus="viewBeneficiaryModal"
        class="relative h-full overflow-y-auto p-4 flex items-center justify-center z-50 select-none">
        ...
        <div class="size-full max-w-7xl">
            <div x-data="{ deleteBeneficiaryModal: $wire.entangle('deleteBeneficiaryModal'), viewCredentialsModal: $wire.entangle('viewCredentialsModal'), confirmTypeChangeModal: $wire.entangle('confirmTypeChangeModal') }" class="relative bg-white rounded-md shadow">
                ...
                @if ($this->beneficiary)
                    <form wire:submit.prevent="editBeneficiary" class="p-4 md:p-5 mb-4">
                        <div class="grid gap-4 grid-cols-1 sm:grid-cols-3 md:grid-cols-5 text-xs">
                            ...
                            @if ($editMode)
                                ...
                                {{-- Last Name --}}
                                <div class="relative mb-4 pb-1">
                                    <label for="last_name" class="block mb-1  font-medium text-indigo-1100 ">Last Name
                                ...
                                {{-- Birthdate --}}
                                <div x-data="{ birthdate: $wire.entangle('birthdate') }" class="relative mb-4 pb-1">
                                    <label for="birthdate" class="block mb-1  font-medium text-indigo-1100 ">Birthdate
                                        <span class="text-red-700 font-normal text-xs">*</span></label>
                                    <div
                                    ...
                                    <input type="text" id="view-beneficiary-birthdate" datepicker
                                        datepicker-autohide datepicker-format="mm-dd-yyyy"
                                        datepicker-min-date='{{ $minDate }}'
                                        datepicker-max-date='{{ $maxDate }}' id="birthdate" autocomplete="off"
                                        wire:model="birthdate"
                                        @change-date.camel="birthdate = $el.value; $wire.nameCheck();"
                                ...
                                {{-- Occupation --}}
                                <div x-data="{ avg: $wire.entangle('avg_monthly_income') }" class="relative mb-4 pb-1">
                                    <label for="occupation"
                                        class="block mb-1  font-medium text-indigo-1100 ">Occupation <span
                                ...
                                {{-- Bottom Section --}}
                                <div
                                    class="relative grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 gap-x-4 gap-y-2 col-span-full sm:grid-rows-2">

                                    {{-- Proof of Identity --}}
                                    <div class="relative h-full row-span-full">
                                        <div class="flex flex-col h-full items-start">
                                            <div class="flex items-center">
                                                <p class="inline mb-1 font-medium text-indigo-1100">Proof of Identity
                                    ...
                                    {{-- ID Type --}}
                                    <div class="relative sm:row-span-1 mb-4 pb-1">
                                    ...
                                    {{-- ID Number --}}
                                    <div class="relative sm:row-span-1 mb-4 pb-1">
                                        <label for="id_number" class="block mb-1 font-medium text-indigo-1100 ">ID
                                            Number
                                            <span class="text-red-700 font-normal text-xs">*</span></label>
                                    ...
                                    {{-- Spouse First Name --}}
                                    <div class="relative sm:row-start-2 mb-4 pb-1">
                                    ...
                                    {{-- Spouse Last Name --}}
                                    <div class="relative sm:row-start-2 flex flex-col mb-4 pb-1">
                                ...
                                <div class="relative col-span-full w-full flex items-center justify-end">
                                    <div class="flex items-center justify-end relative">
                                        ...
                                        <button wire:click.prevent="editBeneficiary" wire:loading.attr="disabled"
                                            ...
                                            class="gap-2 py-2 px-4 text-center font-bold flex items-center disabled:opacity-75 text-green-50 bg-green-700 hover:bg-green-800 active:bg-green-900 rounded">
                                            <p>SAVE</p>
                                        ...
                                        <button type="button" wire:click.prevent="toggleEdit"
                                            ...
                                            class="duration-200 ease-in-out flex shrink items-center justify-center ms-2 p-3 rounded outline-none font-bold text-sm disabled:opacity-75 border border-red-700 hover:border-transparent hover:bg-red-800 active:bg-red-900 text-red-700 hover:text-red-50">

                                            {{-- Loading Icon --}}
                                            <svg class="size-3 animate-spin" wire:loading wire:target="toggleEdit"
                                                xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24">
                                                <circle class="opacity-25" cx="12" cy="12" r="10"
                                                    stroke="currentColor" stroke-width="4">
                                            ...
                                            {{-- X Icon --}}
                                            <svg class="size-3" aria-hidden="true" wire:loading.remove
                                                wire:target="toggleEdit" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 14 14">
                                                <path stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="2"
                                                    d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
