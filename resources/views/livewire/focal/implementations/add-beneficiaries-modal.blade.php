            ...
            <form wire:submit.prevent="saveBeneficiary" class="p-4 md:p-5">
                ...
                <div class="grid gap-4 mb-4 grid-cols-10 text-xs">
                    ...
                    <div class="relative col-span-full sm:col-span-3 mb-4 pb-1">
                        <label for="first_name" class="block mb-1 font-medium text-green-1100 ">First Name</label>
                    ...
                    <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                        <label for="middle_name" class="block mb-1  font-medium text-green-1100 ">Middle Name</label>
                    ...
                    {{-- Last Name --}}
                    <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                        <label for="last_name" class="block mb-1  font-medium text-green-1100 ">Last Name</label>
                    ...
                    <div class="relative col-span-full sm:col-span-1 mb-4 pb-1">
                        <label for="extension_name" class="block mb-1  font-medium text-green-1100 ">Ext. Name</label>
                        <input type="text" id="extension_name" autocomplete="off" wire:model.blur="extension_name"
                            class="text-xs border outline-none rounded block w-full p-2 duration-200 ease-in-out bg-green-50 border-green-300 text-green-1100 focus:ring-green-600 focus:border-green-600"
                            placeholder="III, Sr., etc.">
                    </div>
                    {{-- Birthdate --}}
                    <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                        <label for="birthdate" class="block mb-1  font-medium text-green-1100 ">Birthdate</label>
                    ...
                    {{-- Occupation --}}
                    <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                        <label for="occupation" class="block mb-1  font-medium text-green-1100 ">Occupation</label>
                    ...
                    <div x-data="{
                        ...
                        <label for="avg_monthly_income" class="block mb-1  font-medium text-green-1100 ">Average
                            Monthly
                            Income</label>
                        <div class="relative">
                            <div
                    ...
                    <div class="relative col-span-full sm:col-span-3 mb-4 pb-1">
                        <div class="flex items-center">
                            <label for="dependent" class="block mb-1 font-medium text-green-1100 ">Dependent</label>
                    ...
                    <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                        <div class="flex items-center">
                            <p class="inline mb-1 font-medium text-green-1100">I.i.W.E.o.S.E.</p>
                            <div class="relative flex items-center" id="self-employment-question-mark">
                                <svg @mouseenter="$store.selfEmploymentPopover.toggle()"
                                    ...
                                    class="size-3 outline-none duration-200 ease-in-out cursor-pointer block mb-1 ms-1 rounded-full text-gray-500 hover:text-green-700"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path
                                ...
                                <div id="self-employment-popover" x-transition.origin.bottom
                                    class="absolute z-50 text-xs whitespace-nowrap text-green-50 bg-green-900 rounded ms-2 p-2 shadow"
                    ...
                    <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                        <p class="mb-1 font-medium text-green-1100 ">Skills Training Needed?</p>
                        <div x-data="{
                            open: false,
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="relative flex items-center" id="is-pwd-question-mark">
                                ...
                                <div id="is-pwd-popover" x-transition.origin.bottom.right
                                    class="absolute z-50 text-xs whitespace-nowrap text-green-50 bg-green-900 rounded p-2 shadow"
                    ...
                    <div class="relative grid gap-x-4 gap-y-2 grid-cols-10 col-span-full grid-rows-2">
                        ...
                        <div class="relative col-span-full row-span-full sm:col-span-2 mb-4 pb-1">
                            <div class="flex flex-col items-start">
                                <div class="flex items-center">
                                    <p class="inline mb-1 font-medium text-green-1100">Proof of Identity <span
                                ...
                                <label for="image_file_path"
                                    class="flex flex-col items-center justify-center w-full h-40 border-2 border-green-300 border-dashed rounded cursor-pointer bg-green-50">
                                    {{-- Loading State for Changes --}}
                                    <div class="absolute items-center justify-center w-full h-[88%] z-50 text-green-900"
                        ...
                        {{-- ID Type --}}
                        <div
                            class="relative col-span-full sm:col-span-4 {{ $civil_status === 'Married' ? 'sm:row-span-1' : 'sm:row-span-full' }} mb-4 pb-1">
                        ...
                        <div
                            class="relative col-span-full sm:col-span-4 {{ $civil_status === 'Married' ? 'sm:row-span-1' : 'sm:row-span-full' }} mb-4 pb-1">
                            <label for="id_number" class="block mb-1 font-medium text-green-1100 ">ID Number</label>
                        ...
                        @if ($civil_status === 'Married')
                            {{-- Spouse First Name --}}
                            <div class="relative col-span-full sm:col-span-3 mb-4 pb-1">
                                <label for="spouse_first_name" class="block mb-1 font-medium text-green-1100 ">Spouse
                                    First Name</label>
                                <input type="text" id="spouse_first_name" autocomplete="off"
                                    wire:model.blur="spouse_first_name"
                                    class="text-xs border outline-none rounded block w-full p-2 duration-200 ease-in-out {{ $errors->has('spouse_first_name') ? 'border-red-500 bg-red-200 focus:ring-red-500 focus:border-red-300 focus:ring-offset-red-100 text-red-900 placeholder-red-600' : 'bg-green-50 border-green-300 text-green-1100 focus:ring-green-600 focus:border-green-600' }}"
                            ...
                            {{-- Spouse Middle Name --}}
                            <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                                <label for="spouse_middle_name" class="block mb-1 font-medium text-green-1100 ">Spouse
                                    Middle Name</label>
                            ...
                            <div class="relative flex flex-col col-span-full sm:col-span-2 mb-4 pb-1">
                                <label for="spouse_last_name" class="block mb-1 font-medium text-green-1100 ">Spouse
                                    Last Name</label>
                                <input type="text" id="spouse_last_name" autocomplete="off"
                                    wire:model.blur="spouse_last_name"
                                    class="text-xs border outline-none rounded block w-full p-2 duration-200 ease-in-out {{ $errors->has('spouse_last_name') ? 'border-red-500 bg-red-200 focus:ring-red-500 focus:border-red-300 focus:ring-offset-red-100 text-red-900 placeholder-red-600' : 'bg-green-50 border-green-300 text-green-1100 focus:ring-green-600 focus:border-green-600' }}"
                                    placeholder="Type spouse first name">
                            ...
                            <div class="relative col-span-full sm:col-span-1 mb-4 pb-1">
                                <label for="spouse_extension_name"
                                    class="block mb-1 font-medium text-green-1100 ">Spouse
                                    Ext. Name</label>
