                ...
                <form wire:submit.prevent="saveBatches">
                    ...
                    <div class="flex items-center justify-between py-2 px-4 rounded-t ">
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <button type="button" @click="$wire.resetEverything(); assignBatchesModal = false;"
                            ...
                            <div x-data="{ show: false, barangay_name: $wire.entangle('barangay_name') }" class="relative flex flex-col col-span-3 sm:col-span-2 mb-4">
                                ...
                                <div x-show="show" @click.away=" if(show == true) { show = !show; }"
                                    ...
                                    <div class="relative flex items-center justify-center py-1 group">
                                        ...
                                        <input id="searchBarangay" wire:model.live.debounce.500ms="searchBarangay"
                            ...
                            <div class="relative col-span-2 sm:col-span-1 mb-4">
                                ...
                                <div class="relative">
                                    <input type="number" inputmode="numeric" min="0" id="slots_allocated"
                                        autocomplete="off"
                                        @input="$wire.liveUpdateRemainingSlots(); $wire.set('slots_allocated', $el.value)"
                            ...
                            <div x-data="{ show: false, currentCoordinator: $wire.entangle('currentCoordinator'), selectedCoordinatorKey: $wire.entangle('selectedCoordinatorKey') }" class="relative flex flex-col col-span-5 sm:col-span-2 mb-4">
                                ...
                                <div class="relative z-50 h-full">
                                    <button type="button" id="coordinator_name"
                                        @if ($coordinators) @click="show = !show;" @endif
                                        class="w-full h-full border {{ $coordinators ? 'bg-indigo-50 border-indigo-300 text-indigo-1100 focus:ring-indigo-600 focus:border-indigo-600' : 'bg-gray-50 border-gray-300 text-indigo-500' }} outline-none text-sm px-4 py-2.5 rounded flex items-center justify-between duration-200 ease-in-out">
                                    ...
                                    @if ($coordinators)
                                        <div x-show="show"
                                            @click.away="
                                                    ...
                                                    "
                                            class="end-0 absolute text-indigo-1100 bg-indigo-50 shadow-lg border border-indigo-300 rounded p-3 mt-2">
                                            <div class="relative flex items-center justify-center py-1 group">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                    fill="currentColor"
                                                ...
                                                <input id="searchCoordinator"
                                                    wire:model.live.debounce.500ms="searchCoordinator" type="text"
                                                    class="rounded w-full ps-8 text-xs text-indigo-1100 border-indigo-200 hover:placeholder-indigo-500 hover:border-indigo-500 focus:border-indigo-900 focus:ring-1 focus:ring-indigo-900 focus:outline-none duration-200 ease-in-out"
                                            ...
                                            <ul
                                                ...
                                                @foreach ($coordinators as $key => $coordinator)
                                                    <li wire:key={{ $key }}>
                                                        <button type="button"
                                                            @click="show= !show; currentCoordinator = '{{ $this->getFullName($key) }}'; selectedCoordinatorKey = {{ $key }}"
                                ...
                                <div class="relative col-span-5">
                                    ...
                                    <div class="relative flex">
                                        ...
                                        <button type="button" wire:click="addBatchRow"
                                            class="flex items-center justify-center space-x-2 text-sm py-2 px-3 whitespace-nowrap rounded ms-4 font-bold uppercase bg-indigo-700 hover:bg-indigo-800 active:bg-indigo-900 focus:ring-indigo-300 focus:ring-4 text-indigo-50 focus:outline-none duration-200 ease-in-out">
                                            <p>create batch</p>
                                                        ...
                                                        @foreach ($batchListCoordinators as $keyCoordinator => $coordinator)
                                                            <li wire:key={{ $keyCoordinator }}>
                                                                <button
                                                                    ...
                                                                    {{ $this->getListFullName($keyCoordinator) }}
                                                                </button>
                                                            </li>
                                                        @endforeach
                                                    </ul>
