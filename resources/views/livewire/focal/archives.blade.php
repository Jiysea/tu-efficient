    ...
    <div :class="{
        ...
        <div class="p-2 min-h-screen select-none">
            ...
            <div class="relative flex items-center justify-between w-full my-2 lg:my-0 lg:h-[7.5vh] gap-2">
                ...
                {{-- Loading State --}}
                <template x-if="!isMobile">
                    <svg class="size-6 text-indigo-900 animate-spin" wire:loading.flex
                        wire:target="calendarStart, calendarEnd, selectRestore, selectDelete, selectRow, restoreRow, permanentlyDelete"
                        ...
                        <div class="mx-2 flex items-center justify-end">
                            ...
                            <div class="relative me-2">
                                <div
                                    ...
                                    {{-- Search Icon --}}
                                    <svg class="size-3" wire:loading.remove wire:target="searchArchives"
