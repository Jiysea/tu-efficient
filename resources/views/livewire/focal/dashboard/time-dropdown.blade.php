<div class="relative flex my-4">
    ...
    <button id="timeButton" data-dropdown-toggle="timeDropdown"
    ...
    <!-- Dropdown menu -->
    <div id="timeDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
        <ul class="py-2 text-sm text-gray-700 " aria-labelledby="timeButton">
            <li>
            ...
            <li>
                <a wire:click.prevent="updateCurrentItem(1)" wire:loading.attr="disabled"
                    aria-label="{{ __('This month') }}" class="block px-4 py-2 hover:bg-gray-100 cursor-pointer">This
                    month</a>
            </li>
            <li>
                <a wire:click.prevent="updateCurrentItem(2)" wire:loading.attr="disabled"
                    aria-label="{{ __('Past 3 months') }}" class="block px-4 py-2 hover:bg-gray-100 cursor-pointer">Past
                    3 months</a>
            </li>
            <li>
                <a wire:click.prevent="updateCurrentItem(3)" wire:loading.attr="disabled"
                    aria-label="{{ __('Past 6 months') }}" class="block px-4 py-2 hover:bg-gray-100 cursor-pointer">Past
                    6 months</a>
            </li>
            <li>
