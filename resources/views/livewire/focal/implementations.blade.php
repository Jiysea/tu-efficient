        ...
        'xl:ml-64': open === true,
            ...
            <div class="p-2 min-h-screen select-none">
                ...
                <div class="relative flex items-center my-2">
                    ...
                    {{-- Loading State --}}
                    <div class="absolute items-center justify-end z-50 min-h-full min-w-full text-indigo-900" wire:loading.flex wire:target="setStartDate, setEndDate, selectImplementationRow, selectBatchRow, selectBeneficiaryRow, loadMoreImplementations, loadMoreBeneficiaries, updateImplementations, updateBatches, viewProject, viewBatch, assignBatch">
                ...
                <div class="relative grid grid-cols-1 w-full h-full gap-4 lg:grid-cols-5">
                    {{-- List of Projects --}}
                    <div x-data="{ openProjectModal: $wire.entangle('openProjectModal') }" class="relative lg:col-span-3 h-full w-full rounded bg-white shadow">
                        ...
                        <div class="relative max-h-12 flex items-center justify-between">
                            ...
                            <div class="mx-2 flex items-center justify-end">
                                {{-- Loading State --}}
                                <div class="items-center justify-end z-50 text-indigo-900" wire:loading wire:target="searchProjects">
                                    <svg class="size-4 mr-3 -ml-1 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4">
                                        </circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
                                        </path>
                                ...
                                <div class="relative me-2">
                                    <div class="absolute inset-y-0 start-0 flex items-center ps-2 pointer-events-none">
                                        <svg class="size-3 {{ $this->implementations->isNotEmpty() || $searchProjects ? 'text-indigo-800' : 'text-zinc-400' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                ...
                                <button data-modal-target="create-modal" data-modal-toggle="create-modal" @click="trapCreate=true" class="flex items-center bg-indigo-900 hover:bg-indigo-800 text-indigo-50 hover:text-indigo-100 rounded-md px-4 py-1 text-sm font-bold focus:ring-indigo-500 focus:border-indigo-500 focus:outline-indigo-500 duration-200 ease-in-out">
                                    CREATE
                        ...
                        <div id="implementations-table" class="relative h-[36vh] overflow-y-auto overflow-x-auto scrollbar-thin scrollbar-track-indigo-50 scrollbar-thumb-indigo-700">
                            <table class="relative w-full text-sm text-left text-indigo-1100 whitespace-nowrap">
                                ...
                                <tbody class="relative text-xs">
                                    ...
                                    <tr wire:key="implementation-{{ $key }}" @if (!$this->beneficiaries->isEmpty()) @click="scrollToTop()" @endif
                    ...
                    {{-- List of Batches --}}
                    <div x-data="{ openBatchModal: $wire.entangle('openBatchModal'), assignBatchesModal: $wire.entangle('assignBatchesModal') }" class="relative lg:col-span-2 h-full w-full rounded bg-white shadow">
                        <div class="relative flex justify-between max-h-12 items-center">
                            ...
                            <div class="mx-2 flex items-center">
                                ...
                                @endif
                                <button @if (!$remainingBatchSlots || $remainingBatchSlots===null || $remainingBatchSlots===0) disabled @endif @if ($implementationId) wire:click.prevent="assignBatch" @endif class="flex items-center rounded-md px-3 py-1 text-sm font-bold duration-200 ease-in-out {{ $remainingBatchSlots > 0 ? 'bg-indigo-900 hover:bg-indigo-800 text-indigo-50 hover:text-indigo-100 focus:ring-indigo-500 focus:border-indigo-500 focus:outline-indigo-500' : 'bg-indigo-300 text-indigo-50' }}">
                                    ASSIGN
                        ...
                        <div id="batches-table" class="relative h-[36vh] overflow-y-auto scrollbar-thin scrollbar-track-indigo-50 scrollbar-thumb-indigo-700">
                            ...
                            <table class="relative w-full text-sm text-left text-indigo-1100">
                                ...
                                <tbody class="text-xs relative">
                                    ...
                                    <tr wire:key="batch-{{ $key }}" @if (!$this->beneficiaries->isEmpty()) @click="scrollToTop()" @endif
                                        ...
                                        <td class="py-2">
                                            <p class="px-1 py-1 text-xs rounded font-semibold uppercase {{ $batch->approval_status === 'approved' ? 'bg-green-300 text-green-950' : 'bg-amber-300 text-amber-950' }}  text-center">
                    ...
                    <div class="relative lg:col-span-5 h-full w-full rounded bg-white shadow">
                        ...
                        <div class="relative max-h-12 items-center grid row-span-1 grid-cols-2">
                            ...
                            <div class="col-span-1 mx-2 flex items-center justify-end">
                                {{-- Loading State --}}
                                <div class="items-center justify-end z-50 text-indigo-900" wire:loading wire:target="searchBeneficiaries">
                                    <svg class="size-4 mr-3 -ml-1 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4">
                                        </circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
                                ...
                                <div class="relative me-2">
                                    <div class="absolute inset-y-0 start-0 flex items-center ps-2 pointer-events-none">
                                        <svg class="size-3 {{ $beneficiarySlots['num_of_beneficiaries'] ? 'text-indigo-800' : 'text-zinc-400' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
                                        </svg>
                                    </div>
                                ...
                                <button @if ($batchId && $beneficiarySlots['batch_slots_allocated']> $beneficiarySlots['num_of_beneficiaries']) data-modal-target="add-beneficiaries-modal" data-modal-toggle="add-beneficiaries-modal" @click="trapAdd = true" @else disabled @endif
                        ...
                        <div id="beneficiaries-table" class="relative h-[38.5vh] overflow-y-auto overflow-x-auto scrollbar-thin scrollbar-track-indigo-50 scrollbar-thumb-indigo-700">
                            <table class="relative w-full text-sm text-left text-indigo-1100">
                                ...
                                <tbody class="text-xs">
                                    ...
                                    <tr wire:key="beneficiary-{{ $key }}" wire:click.prevent="selectBeneficiaryRow({{ $key }}, '{{ encrypt($beneficiary->id) }}')" class="relative {{ $selectedBeneficiaryRow === $key ? 'bg-gray-200 text-indigo-900 hover:bg-gray-300' : ' hover:bg-gray-50' }} border-b whitespace-nowrap">
                                        <th scope="row" class="pe-2 border-r border-gray-200 ps-4 py-2 font-medium">
                                            {{ $key + 1 }}
                                        </th>
