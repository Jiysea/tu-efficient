                    ...
                    <div x-show="viewImageModal" x-trap.noscroll.noautofocus="viewImageModal"
                        ...
                        <div class="w-full">
                            ...
                            <button type="button" @click="viewImageModal = false;"
                                class="absolute flex items-center justify-center top-0 right-0 m-4 outline-none text-green-50 focus:bg-green-50 focus:text-green-800 hover:bg-green-50 hover:text-green-800 rounded size-8 duration-300 ease-in-out">
