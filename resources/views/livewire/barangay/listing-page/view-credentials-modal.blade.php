<div x-cloak class="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto backdrop-blur-sm z-50"
    x-show="viewCredentialsModal" x-trap.noautofocus.noscroll="viewCredentialsModal">

    <!-- Modal -->
    <div x-show="viewCredentialsModal" class="min-h-screen p-4 flex items-center justify-center z-auto select-none">

        {{-- The Modal --}}
        <div class="relative size-full max-w-4xl">
            <div x-data="{ viewImageModal: $wire.entangle('viewImageModal') }" class="relative bg-white rounded-md shadow">
                                ...
                                <div class="flex flex-col items-start">
                                    ...
                                    @if ($this->credentials->image_file_path)
                                        <button type="button" @click="viewImageModal = !viewImageModal;"
                                            ...
                                            <img src="{{ route('credentials.baranagay.show', ['filename' => $this->credentials->image_file_path]) }}"
                                    ...
                                    @else
                                        <div
                                            class="relative flex flex-1 flex-col items-center justify-center col-span-1 bg-green-50 w-[90%] aspect-square rounded">
                ...
                <div x-cloak>
                    <!-- Modal Backdrop -->
                    <div class="fixed inset-0 bg-black bg-opacity-90 backdrop-blur-sm z-50" x-show="viewImageModal">
                    </div>
