            ...
            <div x-data="{ confirmTypeChangeModal: $wire.entangle('confirmTypeChangeModal') }" class="relative bg-white rounded-md shadow">
                ...
                <form wire:submit.prevent="editBeneficiary" class="p-4 md:p-5">
                    <div class="grid gap-4 sm:gap-2 grid-cols-10 text-xs">
                        ...
                        {{-- Similarity Results --}}
                        <div x-data="{ addReasonModal: $wire.entangle('addReasonModal') }" class="relative col-span-full mb-2">
                                ...
                                <div class="flex items-center justify-between border rounded text-xs p-2 duration-200 ease-in-out"
                                    ...
                                    @elseif (!$isPerfectDuplicate && !$isResolved)
                                        <p class="inline mx-2">There are
                                            possible
                                            duplicates found
                                            associated with this name. You may proceed if you think this is a mistake.
                                        </p>
                                    @elseif($isResolved)
                        ...
                        <div class="relative col-span-full sm:col-span-3 mb-4 pb-1">
                            <label for="edit_first_name" class="block mb-1 font-medium text-green-1100 ">First Name
                        ...
                        {{-- Last Name --}}
                        <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                            <label for="edit_last_name" class="block mb-1  font-medium text-green-1100 ">Last Name
                                <span class="text-red-700 font-normal text-xs">*</span></label>
                        ...
                        <div class="relative col-span-full sm:col-span-1 mb-4 pb-1">
                            ...
                            @error('extension_name')
                                <p class="text-red-500 absolute left-0 top-full z-10 text-xs whitespace-nowrap">
                                    {{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div x-data="{ birthdate: $wire.entangle('birthdate') }" class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                            <label for="edit_birthdate" class="block mb-1  font-medium text-green-1100 ">Birthdate
                                <span class="text-red-700 font-normal text-xs">*</span></label>
                        ...
                        {{-- Contact Number --}}
                        <div class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                            <label for="edit_contact_num" class="block mb-1 font-medium text-green-1100 ">Contact
                            ...
                            @error('contact_num')
                                <p class="whitespace-nowrap text-red-500 absolute left-0 top-full z-10 text-xs">
                                    {{ $message }}
                                </p>
                            @enderror
                        </div>
                        ...
                        <div x-data="{ avg: $wire.entangle('avg_monthly_income') }" class="relative col-span-full sm:col-span-2 mb-4 pb-1">
                            <label for="edit_occupation" class="block mb-1  font-medium text-green-1100 ">Occupation
                        ...
                        <div class="relative grid gap-x-4 gap-y-2 grid-cols-10 col-span-full grid-rows-2">
                            ...
                            {{-- Proof of Identity --}}
                            <div class="relative h-full col-span-full row-span-full sm:col-span-2 mb-4 pb-1">
                                <div class="flex flex-col h-full items-start">
                                    ...
                                    <label for="image_file_path"
                                        class="duration-200 ease-in-out flex flex-col items-center justify-center size-full border-2 {{ $errors->has('image_file_path') ? 'border-red-300 bg-red-50 text-red-500' : 'border-green-300 bg-green-50 text-gray-500' }} border-dashed rounded cursor-pointer">

                                        {{-- Image Preview --}}
                                        <div class="relative flex flex-col items-center justify-center py-4 size-full">
                                            {{-- Loading State for Changes --}}
                                            <div class="absolute items-center justify-center size-full z-50 text-green-900"
                                                wire:loading.flex wire:target="image_file_path">
                                                <div class="absolute bg-black opacity-15 rounded size-full z-50">
                                                    {{-- Darkness... --}}
                                                </div>
                                           ...
                                           @endif
                                                {{-- Default --}}
                                            @else
                                                <svg class="size-8 mb-2" aria-hidden="true"
                                                    xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 20 16">
                                                    <path stroke="currentColor" stroke-linecap="round"
                                                        stroke-linejoin="round" stroke-width="2"
                                                ...
                                                <p class="mb-2 text-xs text-center"><span class="font-semibold">Click
                                                        to
                                                        upload</span> or drag and drop</p>
                                                <p class="text-xs text-center">PNG or JPG (MAX. 5MB)</p>
                                            @endif
                                        </div>
                                    ...
                                    @error('image_file_path')
                                        <p
                                            class="text-center whitespace-nowrap w-full text-red-500 absolute top-full z-10 text-xs">
                                            {{ $message }}</p>
                                    @enderror
                                </div>
                            </div>
                            ...
                            {{-- ID Number --}}
                            <div class="relative col-span-full sm:col-span-3 sm:row-span-1 mb-4">
                                <div class="relative flex flex-col items-start justify-start pb-1">
                                    <label for="id_number" class="block mb-1 font-medium text-green-1100 ">ID Number
                                        <span class="text-red-700 font-normal text-xs">*</span></label>
                                    ...
                                    @error('id_number')
                                        <p class="text-red-500 absolute top-full left-0 z-10 text-xs">{{ $message }}
                                        </p>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="relative col-span-full sm:col-span-3 mb-4 pb-1">
                                <div class="relative flex flex-col items-start justify-start pb-1">
                                    ...
                                    <input type="text" id="edit_spouse_first_name" autocomplete="off"
                                        ...
                                        class="text-xs border outline-none rounded block w-full p-2 duration-200 ease-in-out @if ($civil_status === 'Married') {{ $errors->has('edit_spouse_first_name') ? 'border-red-500 bg-red-200 focus:ring-red-500 focus:border-red-300 focus:ring-offset-red-100 text-red-900 placeholder-red-600' : 'bg-green-50 border-green-300 text-green-1100 focus:ring-green-600 focus:border-green-600' }}
                                    @else
                                    bg-gray-200 border-gray-300 text-gray-500 @endif"
                                        placeholder="Type spouse first name">
                                    @error('edit_spouse_first_name')
                                        <p class="text-red-500 absolute top-full left-0 z-10 text-xs">{{ $message }}
                                        </p>
                                    @enderror
                                </div>
                            ...
                            <div class="relative flex flex-col col-span-full sm:col-span-2 mb-4 pb-1">
                                <div class="relative flex flex-col items-start justify-start pb-1">
                                    ...
                                    <input type="text" id="edit_spouse_last_name" autocomplete="off"
                                        ...
                                        @if ($civil_status === 'Single') disabled @endif
                                        class="text-xs border outline-none rounded block w-full p-2 duration-200 ease-in-out 
                                    @if ($civil_status === 'Married') {{ $errors->has('edit_spouse_last_name') ? 'border-red-500 bg-red-200 focus:ring-red-500 focus:border-red-300 focus:ring-offset-red-100 text-red-900 placeholder-red-600' : 'bg-green-50 border-green-300 text-green-1100 focus:ring-green-600 focus:border-green-600' }}
                                    @else bg-gray-200 border-gray-300 text-gray-500 @endif"
                                        placeholder="Type spouse last name">
                                    @error('edit_spouse_last_name')
                                        <p class="text-red-500 absolute top-full left-0 mt-1 z-10 text-xs">
                                            {{ $message }}
                                        </p>
                                    @enderror
                                </div>
                    ...
                    <div x-show="confirmTypeChangeModal" x-trap.noreturn.noautofocus="confirmTypeChangeModal"
                        ...
                        <div class="">
                            <div class="relative bg-white rounded-md shadow">
                                ...
                                {{-- Modal body --}}
                                <div class="grid w-full place-items-center pt-5 pb-6 px-3 md:px-12 text-green-1100">
                                    ...
                                    <div class="flex items-center justify-center w-full gap-2">
                                        <button type="button"
                                            class="duration-200 ease-in-out flex flex-1 items-center justify-center px-2 py-2.5 rounded outline-none font-bold text-sm border border-gray-500 hover:border-green-800 active:border-green-900 text-gray-500 hover:text-green-800 active:text-green-50 active:bg-green-900"
                                            @if ($confirmChangeType === 'beneficiary_type') @click="$wire.set('beneficiary_type', 'Special Case'); confirmTypeChangeModal = false;"
                                        ...
                                        <button type="button"
                                            ...
                                            class="duration-200 ease-in-out flex flex-1 items-center justify-center px-2 py-2.5 rounded outline-none font-bold text-sm bg-green-700 hover:bg-green-800 active:bg-green-900 text-green-50">YES</button>
                                    </div>
                                </div>
                            </div>
                        </div>
