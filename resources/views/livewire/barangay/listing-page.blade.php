...
<div>
    <div x-data="{
        ...
        <div class="relative flex flex-col sm:flex-row items-center justify-between mb-2">
            ...
            <div class="relative w-full sm:w-auto flex items-center justify-end gap-3">
                ...
                <svg class="absolute right-full me-3 size-6 z-50 text-green-900 animate-spin" wire:loading
                    wire:target="selectBeneficiaryRow, openEdit, loadMoreBeneficiaries, deleteBeneficiary,"
                ...
                <span class="relative" x-data="{ pop: false }">
                    ...
                    <div x-cloak x-show="pop" x-transition.opacity
                        class="absolute z-50 top-full mt-2 right-0 rounded p-2 shadow text-xs md:text-sm font-normal whitespace-nowrap border bg-zinc-900 border-zinc-300 text-indigo-50">
                ...
                <div class="flex flex-col gap-2 mb-2">
                    ...
                    <div class="flex flex-1 flex-col justify-center">
                        ...
                        <span class="flex items-center justify-start gap-2 font-bold text-lg my-2 ms-2 text-green-900">
                            ...
                            <span class="relative" x-data="{ pop: false }">
                                ...
                                <div x-cloak x-show="pop" x-transition.opacity
                                    class="absolute z-50 bottom-full mb-2 -left-20 rounded p-2 shadow text-xs md:text-sm font-normal whitespace-nowrap border bg-zinc-900 border-zinc-300 text-indigo-50">
                            ...
                            @else
                                ...
                                <span class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        ...
                                        class="size-4 me-1 stroke-green-900">
                    ...
                    <div class="flex items-center justify-end mx-2 gap-2">
                        ...
                        <span class="relative" x-data="{ pop: false }">
                            ...
                            <div x-cloak x-show="pop" x-transition.opacity
                                class="absolute z-50 bottom-full mb-2 right-0 rounded p-2 shadow text-xs md:text-sm font-normal whitespace-nowrap border bg-zinc-900 border-zinc-300 text-indigo-50">
                                @if ($this->beneficiaryCount === $this->batch?->slots_allocated)
        ...
        <div x-cloak class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm z-50"
            x-show="deleteBeneficiaryModal" @keydown.window.escape="deleteBeneficiaryModal = false">
