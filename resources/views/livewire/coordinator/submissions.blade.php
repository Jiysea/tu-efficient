        ...
        'md:ml-20 xl:ml-64': open,
            ...
            <div x-data="{}" class="p-2 min-h-screen select-none">
                ...
                <div class="relative flex flex-col lg:flex-row items-center lg:justify-between my-2 gap-2">
                    ...
                    <div class="relative flex items-center justify-between gap-2 w-full lg:w-auto">
                        <div class="flex items-center gap-2">
                            ...
                            <h1 class="sm:text-xl font-semibold sm:font-bold xl:ms-2">Submissions</h1>

                            {{-- Date range picker --}}
                            <div id="submissions-date-range" date-rangepicker datepicker-autohide class="flex items-center gap-2 text-blue-1100 text-xs">
                        ...
                        {{-- Loading State --}}
                        <div class="flex text-blue-900" wire:loading>
                    ...
                    <div class="flex items-center justify-end gap-2 w-full lg:w-auto">
                        ...
                        {{-- Export Button --}}
                        <button type="button" @if ($this->exportBatches->isNotEmpty()) @click="showExportModal = !showExportModal;" @else disabled @endif
                            class="duration-200 ease-in-out flex items-center gap-2 justify-center px-3 py-1.5 rounded-md text-xs sm:text-sm font-bold outline-none disabled:bg-gray-300 disabled:text-gray-500 text-blue-50 bg-blue-700 hover:bg-blue-800 active:bg-blue-900">
                            EXPORT
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-3.5 sm:size-5" xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400" viewBox="0, 0, 400,400">
                                <g>
                ...
                <div class="relative grid grid-cols-1 w-full h-full gap-4 lg:grid-cols-7">
                            ...
                            <div class="flex items-center justify-end">
                                ...
                                <div class="flex items-center gap-2">
                                    <div x-data="{ open: false }" class="relative flex items-center gap-2 text-blue-900">
                                        ...
                                        {{-- Panel --}}
                                        <div id="batchDropdownContent" x-cloak x-show="open" @click.away="$wire.resetFilter(); $wire.set('searchBatches', null); open = false;" :class="{
                                            'block': open === true,
                                            'hidden': open === false,
                                            ...
                                            <div class="mb-2 flex w-full items-center justify-center gap-2">
                                                ...
                                                <div class="relative flex flex-1 items-center">
                                                    <div class="{{ $this->batches->isEmpty() && (!isset($searchBatches) || empty($searchBatches)) ? 'text-gray-500' : 'text-blue-500' }} absolute z-50 inset-y-0 start-0 flex items-center ps-2 pointer-events-none">
                                                        ...
                                                        {{-- Search Icon --}}
                                                        <svg class="size-3" wire:loading.remove wire:target="searchBatches" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
                                                        </svg>
                                                    </div>
                                                    <input type="text" id="batch-search" maxlength="100" @if ($this->batches->isEmpty() && (!isset($searchBatches) || empty($searchBatches))) disabled @endif
                            ...
                            <div class="flex flex-1 w-full items-center">
                                ...
                                <div class="flex flex-1 w-full items-center gap-2">
                                    ...
                                    <div class="relative flex flex-1 w-full items-center">
                                        ...
                                        {{-- Search Icon --}}
                                        <div class="{{ $this->beneficiaries->isEmpty() || (is_null($batchId) && empty($batchId)) ? 'text-gray-500' : 'text-blue-500' }} absolute inset-y-0 start-0 flex items-center ps-2 pointer-events-none">
                            ...
                            <table class="relative w-full text-sm text-left text-blue-1100 whitespace-nowrap">
                                ...
                                <tbody class="relative text-xs">
                                    ...
                                    <tr wire:key="batch-{{ $key }}" wire:loading.class="pointer-events-none" wire:click.prevent='selectBeneficiaryRow({{ $key }}, "{{ encrypt($beneficiary->id) }}")' class="relative border-b whitespace-nowrap duration-200 ease-in-out cursor-pointer" :class="{
                                        ...
                                        <td class="absolute h-full w-1 left-0" :class="{
                    ...
                    {{-- Beneficiary Preview --}}
                    <div class="relative flex flex-col lg:col-span-4 h-[89vh] w-full">
                                    ...
                                    <div class="flex flex-col items-center text-blue-1100">
                                        ...
                                        <div class="flex flex-col items-center justify-center bg-gray-50 text-gray-400 border-gray-300 border rounded mb-2 size-32 aspect-square">
                                            ...
                                            <button class="flex items-center justify-center rounded" @click="$wire.viewCredential('identity');">
                                                <img class="w-[90%]" src="{{ route('credentials.show', ['filename' => $identity]) }}">
                                            </button>
                                            @else
                        ...
                        <div class="relative size-full max-w-xl">
                            <div class="relative bg-white rounded-md shadow">
                                ...
                                <div class="flex items-center justify-between py-2 px-4 rounded-t-md">
                                    ...
                                    {{-- Close Button --}}
                                    <button type="button" @click="deleteBeneficiaryModal = false;" class="outline-none text-blue-400 hover:bg-blue-200 hover:text-blue-900 rounded size-8 ms-auto inline-flex justify-center items-center duration-300 ease-in-out">
                                ...
                                <div class="grid w-full place-items-center py-5 px-3 md:px-16 text-blue-1100 text-xs">
                                    ...
                                    <div class="flex items-center justify-center w-full gap-2">
                                        ...
                                        <button @click="deleteBeneficiaryModal = false;" class="duration-200 ease-in-out flex items-center justify-center px-2 py-2.5 rounded outline-none font-bold text-sm border border-blue-700 hover:border-transparent active:border-transparent hover:bg-blue-800 active:bg-blue-900 text-blue-700 hover:text-blue-50 active:text-blue-50">
                                            CANCEL
                                        </button>
                                        <button type="button" @click="$wire.deleteBeneficiary(); deleteBeneficiaryModal = false;" class="duration-200 ease-in-out flex items-center justify-center px-2 py-2.5 rounded outline-none font-bold text-sm bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-blue-50">
                                            CONFIRM
                                        </button>
                                    </div>
                                </div>
