...
window.matchMedia('(min-width: 1280px)').addEventListener('change', event => {
            ...
            <div x-data="{ addBeneficiariesModal: $wire.entangle('addBeneficiariesModal'), editBeneficiaryModal: $wire.entangle('editBeneficiaryModal'), deleteBeneficiaryModal: $wire.entangle('deleteBeneficiaryModal'), viewCredentialsModal: $wire.entangle('viewCredentialsModal'), approveSubmissionModal: $wire.entangle('approveSubmissionModal') }" class="p-2 min-h-screen select-none">
                ...
                <div class="relative flex items-center justify-between my-2">
                    <div class="flex items-center">
                        ...
                        {{-- Date range picker --}}
                        <div id="submissions-date-range" date-rangepicker datepicker-autohide class="flex items-center gap-2 text-blue-1100">

                            {{-- Start --}}
                            <div class="relative flex flex-1 w-[8rem]">
                                <div class="absolute text-blue-900 inset-y-0 start-0 flex items-center ps-2 pointer-events-none">
                                ...
                                <input id="start-date" name="start" type="text" value="{{ $defaultStart }}" class="flex flex-1 bg-white border border-blue-300 text-blue-1100 rounded py-1.5 focus:ring-blue-500 focus:border-blue-500 text-xs w-full ps-7" placeholder="Select date start">
                            </div>
                            ...
                            <div class="relative flex flex-1 w-[8rem]">
                                ...
                                <input id="end-date" name="end" type="text" value="{{ $defaultEnd }}" class="flex flex-1 bg-white border border-blue-300 text-blue-1100 rounded py-1.5 focus:ring-blue-500 focus:border-blue-500 text-xs w-full ps-7" placeholder="Select date end">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-2 me-2">
                        ...
                        <button type="button" @if ( $batchId && $this->beneficiarySlots['num_of_beneficiaries'] < $this->beneficiarySlots['slots_allocated'] &&
                    ...
                    <div class="relative lg:col-span-3 h-[89vh] w-full rounded bg-white shadow">
                            ...
                            <div class="flex items-center justify-end">
                                ...
                                <div class="flex items-center gap-2">
                                    <div x-data="{ open: false }" class="relative flex items-center gap-2 text-blue-900">
                                        ...
                                        {{-- Button --}}
                                        <button type="button" @click="open = !open;" class="{{ $batchId ? 'bg-blue-50 border-blue-700 hover:border-transparent hover:bg-blue-800 active:bg-blue-900 text-blue-700 hover:text-blue-50' : 'border-gray-300 text-gray-300' }} flex items-center gap-2 py-1 px-2 text-sm outline-none font-semibold rounded border duration-200 ease-in-out">
                                            {{ $this->currentBatch }}
                                            @if ($batchId)
                                        ...
                                        {{-- Panel --}}
                                        <div id="batchDropdownContent" x-cloak x-show="open" @click.outside="$wire.resetFilter(); open = false;" :class="{
                                            'block': open === true,
                                            'hidden': open === false,
                                            ...
                                            <div class="mb-2 flex w-full items-center justify-center gap-2">
                                                ...
                                                {{-- Batches Count --}}
                                                <span class="flex items-center gap-2 rounded {{ $this->batches->isNotEmpty() ? 'text-blue-900 bg-blue-100' : 'text-red-900 bg-red-100' }} py-1.5 px-2 text-xs select-none">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-4" xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400" viewBox="0, 0, 400,400">
                                                        <g>
                                                ...
                                                <div class="relative flex flex-1 items-center">
                                                    <div class="absolute z-50 inset-y-0 start-0 flex items-center ps-2 pointer-events-none">

                                                        {{-- Loading Icon --}}
                                                        <svg class="size-3 animate-spin" wire:loading wire:target="searchBatches" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4">
                                                            </circle>
                                                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
                                                            </path>
                                                        ...
                                                        {{-- Search Icon --}}
                                                        <svg class="size-3 text-blue-500" wire:loading.remove wire:target="searchBatches" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
                                                        </svg>
                                                    </div>
                                                    <input type="text" id="batch-search" maxlength="100" autocomplete="off" wire:model.live.debounce.300ms="searchBatches" class="duration-200 outline-none ease-in-out ps-6 py-1.5 text-xs text-blue-1100 placeholder-blue-500 border border-blue-300 rounded w-full bg-blue-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for batch numbers">
                                                </div>
                                                ...
                                                <div x-data="{ open: false }" class="relative">
                                                    ...
                                                    <!-- Panel -->
                                                    <div x-show="open" @click.outside="open = false;" class="absolute flex flex-col flex-1 gap-4 text-xs right-0 mt-2 p-4 z-50 rounded bg-white shadow-lg border border-gray-300">
                                                        ...
                                                        <div class="whitespace-nowrap">
                                                            ...
                                                            <div x-data="{ approved: $wire.entangle('approvalStatuses.approved'), pending: $wire.entangle('approvalStatuses.pending'), }" class="flex items-center gap-3">
                                                                ...
                                                                <label class="flex flex-1 items-center gap-1 rounded px-2 py-1" :class="{
                                                                    'bg-blue-100 text-blue-700': approved,
                                                                    'bg-gray-50 text-gray-700': !approved,
                                                                }" for="approvedStatus">
                                                                    <input id="approvedStatus" type="checkbox" wire:model="approvalStatuses.approved" class="size-3 rounded outline-none focus:ring-0" :class="{
                                                                ...
                                                                <label class="flex flex-1 items-center gap-1 rounded px-2 py-1" :class="{
                                                                    ...
                                                                    <input id="pendingStatus" type="checkbox" wire:model="approvalStatuses.pending" class="size-3 rounded outline-none focus:ring-0" :class="{
                                                            ...
                                                            <div x-data="{ submitted: $wire.entangle('submissionStatuses.submitted'), encoding: $wire.entangle('submissionStatuses.encoding'), unopened: $wire.entangle('submissionStatuses.unopened'), revalidate: $wire.entangle('submissionStatuses.revalidate') }" class="flex flex-col justify-center gap-2">
                                                                <div class="flex items-center gap-3">
                                                                    ...
                                                                    <label class="flex flex-1 items-center gap-1 rounded px-2 py-1" :class="{
                                                                        ...
                                                                        <input id="submittedStatus" type="checkbox" wire:model="submissionStatuses.submitted" class="size-3 rounded outline-none focus:ring-0" :class="{
                                                                    ...
                                                                    <label class="flex flex-1 items-center gap-1 rounded px-2 py-1" :class="{
                                                                        ...
                                                                        <input id="encodingStatus" type="checkbox" wire:model="submissionStatuses.encoding" class="size-3 rounded outline-none focus:ring-0" :class="{
                                                                ...
                                                                <div class="flex items-center gap-3">
                                                                    ...
                                                                    <label class="flex flex-1 items-center gap-1 rounded px-2 py-1" :class="{
                                                                        ...
                                                                        <input id="unopenedStatus" type="checkbox" wire:model="submissionStatuses.unopened" class="size-3 rounded outline-none focus:ring-0" :class="{
                                                                    ...
                                                                    <label class="flex flex-1 items-center gap-1 rounded px-2 py-1" :class="{
                                                                        ...
                                                                        <input id="revalidateStatus" type="checkbox" wire:model="submissionStatuses.revalidate" class="size-3 rounded outline-none focus:ring-0" :class="{
                                                        ...
                                                        <span class="w-full flex items-center justify-end">
                                                            <button @click="$wire.applyFilter(); open = false;" class="w-full flex items-center justify-center px-3 py-1.5 font-bold text-sm rounded bg-blue-700 text-blue-50">APPLY
                                                                FILTER</button>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            {{-- List of Batches --}}
                                            <ul class="px-2 text-sm text-blue-1100 overflow-y-auto h-48 scrollbar-thin scrollbar-track-blue-50 scrollbar-thumb-blue-700" aria-labelledby="batchButton">
                                                @if ($this->batches->isNotEmpty())
                                                @foreach ($this->batches as $key => $batch)
                                                <li wire:key="batch-{{ $key }}">
                                                    <button type="button" @click="open = !open;" wire:loading.class="pointer-events-none" wire:click="selectBatchRow({{ $key }}, '{{ encrypt($batch->id) }}')" class="flex items-center gap-2 w-full px-1 py-2 text-xs hover:text-blue-900 hover:bg-blue-100 duration-200 ease-in-out cursor-pointer">
                                                ...
                                                @endforeach
                                                @else
                                                <li class="flex flex-col items-center justify-center h-full w-full font-medium border rounded bg-gray-50 border-gray-300 text-gray-500">
                                                    @if (in_array(false,
                                ...
                                <div class="flex flex-1 w-full items-center gap-2">
                                    ...
                                    <div class="relative flex items-center gap-1 text-xs font-medium">
                                        <p class="{{ $this->specialCases > 0 ? 'text-amber-900' : 'text-gray-700' }}">
                                            Special Cases: </p>
                                        <span class="py-1 px-2 rounded {{ $this->specialCases > 0 ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 text-gray-700' }} ">{{ $this->specialCases }}</span>
                                    </div>
                                    ...
                                    <div class="relative flex flex-1 w-full items-center">
                                        ...
                                        {{-- Search Icon --}}
                                        <div class="{{ is_null($batchId) && empty($batchId) ? 'text-gray-300' : 'text-blue-500' }} absolute inset-y-0 start-0 flex items-center ps-2 pointer-events-none">

                                            {{-- Loading Icon --}}
                                            <svg class="size-3 animate-spin" wire:loading wire:target="searchBeneficiaries" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4">
                                                </circle>
                                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
                                                </path>
                                            ...
                                            {{-- Search Icon --}}
                                            <svg class="size-3" wire:loading.remove wire:target="searchBeneficiaries" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
                                            </svg>
                                        </div>
                                        <input @if (is_null($batchId) && empty($batchId)) disabled @endif type="text" id="beneficiary-search" maxlength="100" autocomplete="off" wire:model.live.debounce.350ms="searchBeneficiaries" class="{{ is_null($batchId) && empty($batchId) ? 'placeholder-gray-300  border-gray-300' : 'text-blue-1100 placeholder-blue-500 border-blue-300 bg-blue-50 focus:ring-blue-500 focus:border-blue-500' }} caret-blue-700 w-full ps-6 py-1.5  border outline-none text-xs rounded duration-200 ease-in-out" placeholder="Search for beneficiaries">
                                    </div>

                                    {{-- Add Button --}}
                                    <button @if ($this->beneficiarySlots['slots_allocated'] > $this->beneficiarySlots['num_of_beneficiaries']) @click="addBeneficiariesModal = !addBeneficiariesModal;" @else disabled @endif
                                        ...
                                        ADD
                                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400" viewBox="0, 0, 400,400">
                                            <g>
                        ...
                        <div id="beneficiaries-table" class="relative h-[76.25vh] overflow-y-auto overflow-x-auto scrollbar-thin scrollbar-track-white scrollbar-thumb-blue-700">
                            <table class="relative w-full text-sm text-left text-blue-1100 whitespace-nowrap">
                                ...
                                <tbody class="relative text-xs">
                                    ...
                                    <tr wire:key="batch-{{ $key }}" wire:loading.class="pointer-events-none" wire:click.prevent='selectBeneficiaryRow({{ $key }}, "{{ encrypt($beneficiary->id) }}")' class="relative border-b whitespace-nowrap duration-200 ease-in-out cursor-pointer" :class="{
                                        ...
                                        <td class="absolute h-full w-1 left-0 z-50" :class="{
                        ...
                        <div class="relative h-[76.25vh] bg-white px-4 pb-4 pt-2 min-w-full flex items-center justify-center">
                            <div class="relative flex flex-col items-center justify-center border rounded h-full w-full font-medium text-sm text-gray-500 bg-gray-50 border-gray-300">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-12 sm:size-20 mb-4 text-blue-900 opacity-65" xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400" viewBox="0, 0, 400,400">
                                    <g>
                                ...
                                <div class="flex col-span-full sm:col-span-8 flex-col text-blue-1100 gap-1">
                                    ...
                                    <div class="flex flex-1 flex-col px-2 py-1 gap-2">
                                        ...
                                        <div class="flex items-center whitespace-nowrap justify-between gap-2">
                                            ...
                                            <div class="flex flex-1 flex-col justify-center">
                                                <p class="select-all font-medium  capitalize">
                                                    sex </p>
                                                <span class="whitespace-normal bg-blue-50 text-blue-1000 rounded px-2 py-0.5 capitalize select-all">
                                        ...
                                        <div class="flex items-center whitespace-nowrap justify-between gap-2">
                                            ...
                                            <div class="flex flex-1 flex-col justify-center">
                                                ...
                                                <button type="button" @click="$wire.viewCredential('special');" class="relative flex items-center justify-between whitespace-normal rounded capitalize px-2 py-0.5 outline-none bg-amber-100 active:bg-amber-200 text-amber-950 hover:text-amber-700 duration-200 ease-in-out">
                                                    {{ $this->beneficiary->beneficiary_type }}

                                                    <svg xmlns="http://www.w3.org/2000/svg" class="absolute right-2 size-4" xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400" viewBox="0, 0, 400,400">
                                                        <g>
                                                            <path d="M181.641 87.979 C 130.328 95.222,89.731 118.794,59.712 158.775 C 35.189 191.436,35.188 208.551,59.709 241.225 C 108.153 305.776,191.030 329.697,264.335 300.287 C 312.216 281.078,358.187 231.954,358.187 200.000 C 358.187 163.027,301.790 109.157,246.875 93.676 C 229.295 88.720,196.611 85.866,181.641 87.979 M214.728 139.914 C 251.924 148.468,272.352 190.837,256.127 225.780 C 234.108 273.202,167.333 273.905,144.541 226.953 C 121.658 179.813,163.358 128.100,214.728 139.914 M188.095 164.017 C 162.140 172.314,153.687 205.838,172.483 225.933 C 192.114 246.920,228.245 238.455,236.261 210.991 C 244.785 181.789,217.066 154.756,188.095 164.017 " stroke="none" fill="currentColor" fill-rule="evenodd">
                                                            </path>
                                                        </g>
                                                    </svg>
                                                </button>
                                                @else
                                                <span class="whitespace-normal rounded px-2 py-0.5 bg-blue-50 text-blue-1000 capitalize select-all">
                                                    {{ $this->beneficiary->beneficiary_type }}
                                                </span>
                                                @endif
                                    ...
                                    <div class="flex flex-1 px-2 py-1 gap-2">
                                        <div class="relative max-[430px]:flex-col flex flex-1 items-center justify-end gap-2">
                                            ...
                                            {{-- Edit Button --}}
                                            <button @if ($this->batch->approval_status !== 'approved') @click="$wire.openEdit(); $dispatch('openEdit');"
                                                @else
                                                disabled @endif
                                            ...
                                            {{-- Delete Button --}}
                                            <button @if ($this->batch->approval_status !== 'approved') @click="deleteBeneficiaryModal = !deleteBeneficiaryModal;"
                                                @else
                                                disabled @endif
                ...
                <div x-cloak class="fixed inset-0 bg-black overflow-y-auto bg-opacity-50 backdrop-blur-sm z-50" x-show="deleteBeneficiaryModal">

                    <!-- Modal -->
                    <div x-show="deleteBeneficiaryModal" x-trap.noscroll.noautofocus="deleteBeneficiaryModal" class="min-h-screen p-4 flex items-center justify-center z-50 select-none">
                        ...
                        <div class="relative size-full max-w-xl">
                            <div class="relative bg-white rounded-md shadow">
                                ...
                                <div class="flex items-center justify-between py-2 px-4 rounded-t-md">
                                    ...
                                    {{-- Close Button --}}
                                    <button type="button" @click="$wire.resetPassword(); deleteBeneficiaryModal = false;" class="outline-none text-blue-400 hover:bg-blue-200 hover:text-blue-900 rounded  size-8 ms-auto inline-flex justify-center items-center duration-300 ease-in-out">
                                ...
                                {{-- Modal body --}}
                                <div class="grid w-full place-items-center pt-5 pb-10 px-3 md:px-16 text-blue-1100 text-xs">
                                    ...
                                    <form wire:submit.prevent="deleteBeneficiary" class="flex items-center justify-center w-full gap-2">

                                        <div class="relative">
                                            <input type="password" id="password_delete" wire:model.blur="password_delete" class="flex {{ $errors->has('password_delete') ? 'border-red-500 focus:border-red-500 bg-red-100 text-red-700 placeholder-red-500' : 'border-blue-300 focus:border-blue-500 bg-blue-50' }} focus:ring-0 rounded outline-none border p-2.5 text-sm select-all duration-200 ease-in-out" placeholder="Enter your password">
                                        ...
                                        <button type="submit" class="duration-200 ease-in-out flex items-center justify-center px-2 py-2.5 rounded outline-none font-bold text-sm bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-blue-50">CONFIRM</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <div x-cloak>
                    ...
                    <!-- Modal -->
                    <div x-show="approveSubmissionModal" x-trap.noautofocus.noscroll="approveSubmissionModal" class="fixed inset-0 p-4 flex items-center justify-center overflow-y-auto z-50 select-none h-[calc(100%-1rem)] max-h-full">
                            ...
                            <div class="relative bg-white rounded-md shadow">
                                ...
                                <div class="relative flex items-center justify-between py-2 px-4 rounded-t-md">
                                    ...
                                    <div class="flex items-center justify-center">
                                        ...
                                        {{-- Close Modal --}}
                                        <button type="button" @click="$wire.resetPassword(); approveSubmissionModal = false;" class="outline-none text-blue-400 hover:bg-blue-200 hover:text-blue-900 rounded  size-8 ms-auto inline-flex justify-center items-center duration-300 ease-in-out">
                                            <svg class="size-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                            </svg>
                                            <span class="sr-only">Close Modal</span>
                                ...
                                <div class="grid w-full place-items-center pt-5 pb-10 px-3 md:px-16 text-xs">
                                    ...
                                    <div class="relative flex items-center justify-center w-full gap-2">
                                        ...
                                        <button wire:loading.attr="disabled" wire:target="approveSubmission" class="flex items-center justify-center disabled:bg-blue-300 bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-blue-50 py-2.5 px-2 rounded text-sm font-bold duration-200 ease-in-out" wire:click="approveSubmission">
                                            CONFIRM
                                        </button>
                                    </div>
                                </div>
    ...
    }" x-cloak x-show="successShow" x-transition:enter="transition ease-in-out duration-300 origin-left" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="origin-left transition ease-in-out duration-500" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90" class="fixed left-6 bottom-6 z-50 flex items-center border bg-blue-200 text-blue-1000 border-blue-300 rounded-lg text-sm sm:text-md font-bold px-4 py-3 select-none" role="alert">
