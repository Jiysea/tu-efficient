    ...
    <div x-show="importFileModal" x-trap.noscroll="importFileModal"
        ...
        <div class="size-full max-w-5xl">
            ...
            <div x-data="{ downloadSampleModal: $wire.entangle('downloadSampleModal') }" class="relative bg-white rounded-md shadow">
                        ...
                        <div class="flex flex-col items-center justify-center w-3/4">
                            ...
                            <div x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true"
                                ...
                                <span x-show="uploading" class="absolute top-2 right-2 inline-flex z-50">
                                    <button class="text-gray-500 hover:text-blue-900 duration-200 ease-in-out"
                            ...
                            <div class="relative flex flex-col items-center justify-start w-full mt-4 h-40">
                                @if ($file_path && !$errors->has('file_path'))
                                    <span
                                        class="flex justify-between items-center font-medium rounded-md shadow z-50 text-xs p-2 w-full bg-gray-200 hover:bg-blue-200 text-gray-500 hover:text-blue-900 duration-200 ease-in-out">
                                        {{ $file_path->getClientOriginalName() }}

                                        {{-- X button --}}
                                        <button type="button" @click="$wire.clearFiles();"
                                            class="outline-none text-gray-500 hover:text-blue-900 p-2 inline-flex justify-center items-center duration-200 ease-in-out"
                        ...
                        <div class="w-full flex relative items-center justify-end">
                            <span class="flex items-center justify-center">
                                ...
                                <button type="submit" wire:loading.attr="disabled" wire:target="nextStep"
                                    class="flex items-center justify-center px-3 py-1 font-bold bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-blue-50 rounded duration-200 ease-in-out"
                                    wire:click="validateFile">
                                    NEXT

                                    {{-- Loading State for Changes --}}
                                    <svg class="size-4 ms-2 animate-spin z-50" wire:loading wire:target="nextStep"
                                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10"
                                            stroke="currentColor" stroke-width="4">
                                        </circle>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6 ms-2"
                                        wire:loading.class="hidden" wire:target="nextStep"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400"
                                        viewBox="0, 0, 400,400">
                                        <g>
                                            <path
                ...
                @elseif($step === 2)
                    <div class="flex flex-col gap-4 p-4 md:py-5 md:px-16">
                        ...
                        @elseif($importFinished)
                            ...
                            <div x-data="{ expanded: false }" class="w-full flex flex-col gap-4">
                                ...
                                <div x-show="expanded"
                                    ...
                                    <span class="px-2 text-xs">
                                        ...
                                        format, etc.
                                        Make sure to follow the format in your file before uploading it.
                                    </span>
                            ...
                            <div x-data="{ expanded: false }" class="w-full flex flex-col gap-4">
                                ...
                                <div x-show="expanded"
                                    ...
                                    <span class="px-2 text-xs">
                                        ...
                                        For now, the system does not insert these rows for complication reasons so we
                                        recommend you to manually insert these rows.
                                    </span>
                            ...
                            <div x-data="{ expanded: false }" class="w-full flex flex-col gap-4">
                                ...
                                <div x-show="expanded"
                                    ...
                                    <span class="px-2 text-xs">
                                        These are rows that were already a beneficiary two (2) times this year for
                                        underemployment and for special case.
                                        As the name stands, you cannot insert these rows unless they are not
                                        perfect/exact duplicates.
                                    </span>
                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <div class="flex flex-col items-center justify-center mb-20">
                            <span class="flex items-center justify-center mt-10 mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="size-20 sm:size-32 text-blue-900 opacity-65"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400"
                                    viewBox="0, 0, 400,400">
                                    <g>
                                        <path
                            ...
                            <span class="text-lg font-medium text-blue-1100">
                                ...
                                <div class="flex flex-col items-center p-4 md:p-5">
                                    <div class="grid grid-cols-1 my-4 text-xs w-full place-items-center">
                                        <div class="w-full relative mb-4 px-4 pb-1">
                                            <label for="slots_allocated"
                                                class="block mb-1 font-medium text-sm text-blue-1100">How
                                                many slots
                                                you
                                    ...
                                    <div class="w-1/2 flex items-center justify-center gap-4 mb-4">
                                        <button type="button" wire:click="export"
                                            class="flex flex-1 items-center justify-center text-base font-bold px-2 py-1 outline-none text-blue-50 bg-blue-700 hover:bg-blue-800 active:bg-blue-900 rounded text-center duration-200 ease-in-out">
                                            CONFIRM
                                        </button>
                                    </div>
                                </div>
