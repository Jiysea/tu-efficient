                    ...
                    <div class="flex flex-col items-center justify-center w-3/4">
                        ...
                        <div x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true"
                            ...
                            <span x-show="uploading" class="absolute top-2 right-2 inline-flex z-50">
                                <button class="text-gray-500 hover:text-blue-50 duration-200 ease-in-out"
                        ...
                        <div
                            ...
                            <div x-data="{ expanded: false }" class="w-full flex flex-col gap-4">
                                ...
                                <button type="button" @click="expanded = !expanded;"
                                    class="w-full flex flex-1 items-center justify-between px-4 py-3 rounded border border-blue-300 text-blue-1100 text-xs font-medium">
                                    <p>
                                        Successful Records <span
                                            class="ms-2 rounded p-1.5 bg-blue-100 text-blue-700 font-medium text-xs">{{ sizeof($successResults) }}</span>
                                    </p>
