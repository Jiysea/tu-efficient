                ...
                <div class="flex justify-center items-center w-full my-4">
                    ...
                    <div x-show="step == 1" class="flex items-center justify-between">
                        <div class="flex flex-col items-center">
                            <span
                                class="flex items-center justify-center size-9 sm:size-12 bg-blue-700 rounded-full shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-4 sm:size-6 text-blue-50"
                            ...
                            <span class="text-blue-700 text-xs font-medium mt-1">Import</span>
                        </div>
                    ...
                    <div x-show="step == 2" class="flex items-center justify-between">
                        ...
                        <span class="border-b border-4 border-blue-700 w-12 sm:w-20 lg:w-32 mb-5"></span>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <span class="text-blue-700 text-xs font-medium mt-1">Validate</span>
                        </div>
                    ...
                    <div x-show="step == 3" class="flex items-center justify-between">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <span class="text-blue-700 text-xs font-medium mt-1">Finish</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col items-center justify-center w-3/4">
                        ...
                        <div x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true"
                            ...
                            <div x-show="uploading" class="absolute flex items-center justify-center w-2/6 z-40">
                                <div class="w-full bg-gray-300 rounded-lg h-2">
                                    <div class=" h-full {{ $errors->has('file_path') ? 'bg-red-500' : 'bg-blue-500' }} rounded-lg"
                                        x-bind:style="'width: ' + progress + '%'">
                                    </div>
                                </div>
                                <svg class="ms-2 size-5 {{ $errors->has('file_path') ? 'text-red-900' : 'text-blue-900' }} animate-spin"
                            ...
                            <label for="file_path" id="drop-zone"
                                ...
                                {{ $errors->has('file_path')
                                    ...
                                    : 'text-gray-500 hover:text-blue-500 bg-gray-50 hover:bg-blue-50 border-gray-300 hover:border-blue-300' }}
                            ...
                            <span x-show="uploading" class="absolute top-2 right-2 inline-flex z-50">
                                <button
                                    class="text-gray-500 {{ $errors->has('file_path') ? 'hover:text-red-700' : 'hover:text-blue-700' }} duration-200 ease-in-out"
                        ...
                        <div class="flex flex-col items-center justify-center w-full">
                            ...
                            <p class="text-center w-full text-gray-500 z-10 mt-4 text-sm">
                                ...
                                <button type="button" @click="downloadSampleModal = !downloadSampleModal;"
                                    class="bg-blue-100 text-blue-700 hover:text-blue-800 active:text-blue-1000 
                                                rounded px-2 py-1 font-medium underline underline-offset-2 decoration-transparent hover:decoration-blue-800 
                            ...
                            @if (!$this->batch?->is_sectoral)
                                <p class="text-center w-full text-gray-500 z-10 mt-4 text-sm">
                                    ...
                                    the <span class="text-blue-700 font-medium">District</span> and <span
                                        class="text-blue-700 font-medium">BRGY.</span> fields as each
                        ...
                        <div class="relative flex flex-col items-center justify-start w-full mt-4 h-28">
                            @if ($file_path && !$errors->has('file_path'))
                                <span
                                    class="flex justify-between items-center font-medium rounded-md shadow z-50 text-xs p-2 w-full bg-zinc-300 hover:bg-blue-800 text-zinc-700 hover:text-blue-50 duration-200 ease-in-out">
                                    {{ $file_path->getClientOriginalName() }}

                                    {{-- X button --}}
                                    <button type="button" @click="$wire.clearFiles();"
                                        class="outline-none text-gray-500 hover:text-blue-50 p-2 inline-flex justify-center items-center duration-200 ease-in-out">
                    ...
                    <div class="w-full flex relative items-center justify-end">
                        <span class="flex items-center justify-center">
                            ...
                            <button type="type" wire:loading.attr="disabled"
                                ...
                                class="flex items-center justify-center px-3 py-1 font-bold disabled:opacity-75 bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-blue-50 rounded duration-200 ease-in-out"
                    ...
                    @elseif($importFinished && !$importFailed)
                        ...
                        <div class="w-full flex items-center justify-between">
                            <div class="flex flex-col justify-center">
                                <span class="text-sm sm:text-base font-semibold text-blue-700">
                                    Importing Results
                                </span>
                            ...
                            <button
                                class="flex items-center justify-center rounded text-blue-700 hover:text-blue-800 active:text-blue-900 "
                        ...
                        {{-- Results || Tables --}}
                        <div
                            class="flex flex-col gap-3 h-[50vh] px-5 overflow-auto scrollbar-thin scrollbar-track-blue-50 scrollbar-thumb-blue-700">
                            {{-- Successful Inserts --}}
                            <div x-data="{ expanded: false }" class="w-full flex flex-col gap-4">

                                <button type="button" @click="expanded = !expanded;"
                                    class="w-full flex flex-1 items-center justify-between px-4 py-3 rounded border {{ sizeof($successResults) > 0 ? 'border-blue-300 text-blue-1100' : 'border-gray-300 text-gray-950' }} text-xs font-medium">
                                    <p>
                                        Successful Records <span
                                            class="ms-2 rounded p-1.5 {{ sizeof($successResults) > 0 ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-700' }} font-medium text-xs">{{ sizeof($successResults) }}</span>
                                    </p>
                                ...
                                {{-- Table && Description --}}
                                <div x-show="expanded"
                                    class="flex flex-col pt-2 rounded border border-blue-300 bg-blue-50 text-blue-1100">
                                    ...
                                    @if (!empty($successResults) && sizeof($successResults) > 0)
                                                ...
                                                <tbody class="text-xs relative">
                                                    @foreach ($successResults as $key => $result)
                                                        <tr wire:key='success-{{ $key }}'
                                                            class="relative whitespace-nowrap hover:bg-blue-100">
                                    ...
                                    @else
                                        <div x-show="expanded"
                                            ...
                                            <div
                                                class="relative flex flex-col items-center justify-center border rounded h-full w-full font-medium text-sm text-blue-500 bg-blue-50 border-blue-300">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div x-data="{ expanded: false }" class="w-full flex flex-col gap-4">
                                ...
                                <div x-show="expanded"
                                    ...
                                    @if (!empty($perfectResults) && sizeof($perfectResults) > 0)
                            ...
                            <div x-data="{ expanded: false }" class="w-full flex flex-col gap-4">
                                ...
                                <div x-show="expanded"
                                    ...
                                    @if (!empty($errorResults) && sizeof($errorResults) > 0)
                    ...
                    <div
                        ...
                        <span class="flex items-center justify-center">
                            <button type="button" wire:loading.attr="disabled" wire:target="nextStep"
                                ...
                                class="flex items-center justify-center px-3 py-1 font-bold disabled:opacity-75 bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-blue-50 rounded"
                ...
                <div x-show="step == 3" class="p-4 md:p-5">
                    ...
                    <div class="flex flex-col items-center justify-center gap-6 mb-20">
                        <span class="flex items-center justify-center mt-10">
                            <svg xmlns="http://www.w3.org/2000/svg" class="size-20 sm:size-32 text-blue-700"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="400" height="400"
                                viewBox="0, 0, 400,400">
                                <g>
                                    <path
                        ...
                        <span class="text-base font-medium text-blue-1100">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative bg-white rounded-md shadow">
                                ...
                                <div class="flex items-center justify-between py-2 px-4 rounded-t-md">
                                    ...
                                    <div class="flex items-center justify-center">
                                        {{-- Loading State --}}
                                        <div class="flex items-center justify-start me-4 z-50 text-blue-900"
                                ...
                                <div class="flex flex-col items-center gap-4 w-full p-5 md:py-5 md:px-10">
                                    ...
                                    <div class="w-full relative pb-1">
                                        <label for="slots_allocated"
                                            class="block mb-1 font-medium text-sm text-blue-1100">
                                            How
                                            many slots/rows
                                            you
                                    ...
                                    <div class="w-full flex items-center justify-end mb-2">
                                        <button type="button" wire:click="exportSample"
                                            class="flex items-center justify-center text-sm font-bold px-3 py-2 rounded duration-200 ease-in-out outline-none text-blue-50 bg-blue-700 hover:bg-blue-800 active:bg-blue-900 focus:ring-2 focus:ring-offset-1 focus:ring-blue-500">
                                            CONFIRM
                                        </button>
                                    </div>
                                </div>
...
@script
    <script>
        ...
        const defaultStyles = ['bg-gray-50', 'hover:bg-blue-50', 'text-gray-500', 'hover:text-blue-500', 'border-gray-300',
            'hover:border-blue-300'
        ];
        const errorDragStyles = ['bg-orange-50', 'text-orange-500', 'border-orange-500'];
        const defaultDragStyles = ['bg-blue-50', 'text-blue-500', 'border-blue-500'];
