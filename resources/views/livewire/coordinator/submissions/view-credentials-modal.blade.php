                                ...
                                <div class="flex flex-col items-start">
                                    ...
                                    @if ($this->credentials?->image_file_path)
                                        <button type="button" @click="viewImageModal = !viewImageModal;"
                                            class="relative flex items-center justify-center col-span-1 bg-blue-50 size-[90%] aspect-square rounded overflow-hidden group">
                                    ...
                                    @else
                                        <div
                                            class="relative flex flex-1 flex-col items-center justify-center col-span-1 bg-blue-50 size-[90%] aspect-square rounded">
