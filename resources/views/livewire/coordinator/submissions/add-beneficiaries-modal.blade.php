                ...
                <form wire:submit.prevent="saveBeneficiary" class="{{ $is_sectoral ? 'px-5 pt-5 pb-16' : 'p-5' }}">
                    <div
                        ...
                        <div class="{{ isset($similarityResults) ? '' : 'hidden' }} relative col-span-full">
                            ...
                            {{-- TABLE AREA --}}
                            <div x-show="expanded"
                                class="relative min-h-56 max-h-56 rounded border text-xs mt-2 overflow-auto scrollbar-thin 
                                                                    ...
                                                                    @if ($reason_image_file_path)
                                                                        ...
                                                                        <span x-show="!uploading"
                                                                            ...
                                                                            <button wire:loading.attr="disabled"
                                                                                ...
                                                                                type="button"
                                                                                wire:click="$set('reason_image_file_path', null)">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="relative flex flex-col">
                                                                <label for="image_description"
                                                                    class="block mb-1 font-medium text-blue-1100 ">
                                                            ...
                                                            <div class="flex justify-end w-full">
                                                                <button type="button" wire:click.prevent="saveReason"
                                                                    class="px-2 py-1 rounded bg-blue-700 hover:bg-blue-800 active:bg-blue-900 focus:outline-offset-2 focus:outline-blue-300 text-blue-50 font-bold text-lg">
                                                                    CONFIRM
                                                                </button>
                                                            </div>
                                                        </div>
