                ...
                <div class="relative flex items-center my-2">
                    ...
                    <div id="implementations-date-range" date-rangepicker datepicker-autohide class="flex items-center">
                        ...
                        <div class="relative">
                            ...
                            <input id="start-date" name="start" type="text" value="{{ $defaultStart }}" class="bg-white border border-blue-300 text-blue-1100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10" placeholder="Select date start">
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <input id="end-date" name="end" type="text" value="{{ $defaultEnd }}" class="bg-white border border-blue-300 text-blue-1100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10" placeholder="Select date end">
                        </div>
                    </div>
                        ...
                        <div class="relative max-h-12 flex items-center justify-between">
                            ...
                            <div class="mx-2 flex items-center justify-end">
                                <div class="relative me-2">
                                    ...
                                    <input type="text" id="batch-search" maxlength="100" autocomplete="off" @input.debounce.500ms="$wire.searchBatches = $el.value; $wire.$refresh();" class="duration-200 outline-none ease-in-out ps-7 py-1 text-xs text-blue-1100 placeholder-blue-500 border border-blue-300 rounded w-full bg-blue-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for batch numbers">
                                </div>
                                <button class="flex items-center bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-blue-50 hover:text-blue-100 active:text-blue-200 focus:ring-blue-500 focus:border-blue-500 focus:outline-blue-500 rounded px-3 py-1 text-sm font-bold duration-200 ease-in-out">
                                    FILTER
