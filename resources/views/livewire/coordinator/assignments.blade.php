                                        ...
                                        <tr wire:key="batch-{{ $key }}"
                                            ...
                                            <td class="py-1">
                                                <button type="button" wire:loading.attr="disabled"
                                                    ...
                                                    class="flex items-center justify-center z-0 p-1 outline-none rounded duration-200 ease-in-out {{ $selectedBatchRow === $key ? 'hover:bg-blue-700 focus:bg-blue-700 text-blue-900 hover:text-blue-50 focus:text-blue-50' : 'text-gray-900 hover:text-blue-900 focus:text-blue-900 hover:bg-gray-300 focus:bg-gray-300' }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5"
