<nav>
    <aside id="logo-sidebar" :class="{
        ...
        <div :class="{
            ...
            <svg wire:ignore @click="open = !open ; caretRotate += 180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{
        ...
        <div class="relative overflow-visible  flex flex-col justify-between h-full px-3 w-full py-4 bg-blue-900">
            <div class="">
                ...
                }" class="translate-x-0 opacity-100 xl:-translate-x-16 xl:opacity-0 absolute top-3 z-10 bg-blue-100 p-1 rounded-lg object-contain size-10 ms-2 duration-500 ease-in-out select-none" src="{{ asset('assets/f_logo.png') }}" alt="Focal logo">
                ...
                <ul class="space-y-2 font-medium text-sm">
                    ...
                    <li class="relative">
                        ...
                        <div x-show="dashboardHover" x-transition :class="{
                    ...
                    <li class="relative">
                        ...
                        <div x-show="implementationsHover" x-transition :class="{
                                'hidden': (open === true && isAboveBreakpoint === true),
                                'inline-block': (open === false && isAboveBreakpoint === true),
                            }" class="absolute hidden left-full top-0 z-40 text-sm text-gray-500 bg-blue-50 border border-blue-200 rounded shadow-lg">
                            <div class="px-3 py-2 font-semibold text-blue-1100">
                    ...
                    <li class="relative">
                        ...
                        <div x-show="umanagementHover" x-transition :class="{
                                'hidden': (open === true && isAboveBreakpoint === true),
                                'inline-block': (open === false && isAboveBreakpoint === true),
                            }" class="absolute hidden left-full top-0 z-40 text-sm text-gray-500 bg-blue-50 border border-blue-200 rounded shadow-lg">
            ...
            <div>
                <ul class="font-medium text-sm">
                    <li class="relative">
                        ...
                        <div x-show="profileShow" @click.away="profileShow = !profileShow" :class="{
                            ...
                            <ul class="text-sm max-h-44">
                                <li>
                                    <a aria-label="{{ __('Profile') }}" class="flex items-center text-blue-1100 px-4 justify-start py-2 hover:bg-blue-200 hover:text-blue-900 duration-300 ease-in-out cursor-pointer">
                                ...
                                <li>
                                    <a aria-label="{{ __('Settings') }}" class=" flex items-center text-blue-1100 px-4 justify-start py-2 hover:bg-blue-200 hover:text-blue-900 duration-300 ease-in-out cursor-pointer">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 me-2">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <li>
                                        ...
                                        <button type="submit" aria-label="{{ __('Logout') }}" class="flex items-center w-full text-blue-1100 px-4 justify-start py-2 hover:bg-blue-200 hover:text-blue-900 duration-300 ease-in-out cursor-pointer">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 me-2">
