<nav>
    ...
    <div x-data="{ open: false }" id="sm-sidebar" class="md:hidden">
        ...
        <div x-cloak x-trap.noscroll="open" @keyup.escape.window="open = false;" @click.self="open = false;"
            ...
            <div :class="{
                ...
                class="-translate-x-96 w-56 absolute flex flex-col justify-between left-0 top-0 z-50 h-full duration-300 ease-in-out p-4 select-none bg-indigo-900">
                ...
                <div class="flex flex-col gap-3">
                    <div :class="{
                        ...
                        <button type="button" @click="open = false;"
                            class="origin-left p-1 duration-300 ease-in-out outline-none rounded bg-indigo-50 hover:bg-indigo-100 active:bg-indigo-200 text-indigo-900 focus:ring-2 focus:ring-indigo-500">
                            <span class="sr-only">Open sidebar</span>
                        ...
                        <span x-data="{ hover: false }">
                            <a href="{{ route('focal.dashboard') }}" wire:loading.attr="disabled"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    class="flex-shrink-0 size-5 text-indigo-50 duration-300 ease-in-out group-hover:text-indigo-300 group-focus:text-indigo-300"
                                    viewBox="0, 0, 400,400">
                                    <g>
                                        <path
                        ...
                        {{-- <span x-data="{ hover: false }">
                            <a href="{{ route('focal.archives') }}" wire:loading.attr="disabled"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g>
                                        <path
                                            d="M58.036 55.035 C 50.295 57.465,44.134 62.760,40.066 70.480 L 37.891 74.609 37.891 100.000 L 37.891 125.391 40.539 130.275 C 43.757 136.208,48.626 140.847,54.551 143.625 L 58.984 145.703 200.000 145.703 L 341.016 145.703 345.449 143.625 C 351.374 140.847,356.243 136.208,359.461 130.275 L 362.109 125.391 362.109 100.000 L 362.109 74.609 359.461 69.725 C 356.243 63.792,351.374 59.153,345.449 56.375 L 341.016 54.297 201.172 54.149 C 87.069 54.029,60.722 54.192,58.036 55.035 M53.918 237.324 C 53.928 294.914,54.113 306.639,55.080 310.738 C 58.953 327.164,72.833 341.047,89.255 344.919 C 96.582 346.646,303.411 346.648,310.738 344.920 C 327.200 341.039,341.039 327.200,344.920 310.738 C 345.887 306.639,346.072 294.914,346.082 237.324 L 346.094 168.789 343.555 169.355 C 340.236 170.096,59.764 170.096,56.445 169.355 L 53.906 168.789 53.918 237.324 M221.873 205.859 C 230.705 210.426,230.723 222.702,221.905 227.148 C 218.584 228.823,217.547 228.906,200.000 228.906 C 182.453 228.906,181.416 228.823,178.095 227.148 C 169.417 222.772,169.026 212.101,177.336 206.445 C 180.672 204.175,217.674 203.687,221.873 205.859 "
                                            stroke="none" fill="currentColor" fill-rule="evenodd"></path>
                                    </g>
                                </svg>
                                <div :class="{
                ...
                <div x-data="{ account: false }" class="font-medium text-sm">
                    ...
                    <div class="relative">
                        <button @click="account = !account"
                            class="flex items-center gap-2 w-full p-2 text-indigo-50 rounded-lg hover:text-indigo-300 focus:text-indigo-300 hover:bg-indigo-1000 outline-none group duration-300 ease-in-out cursor-pointer">

                            <svg class="text-center flex-shrink-0 size-6 text-indigo-50 duration-300 ease-in-out group-hover:text-indigo-300 group-focus:text-indigo-300"
                        ...
                        <div x-show="account" @click.away="account = !account"
                            ...
                            class="hidden bottom-full mb-3 inset-x-0 mx-auto absolute text-indigo-1100 bg-white shadow-lg border border-indigo-100 rounded">
    ...
    <div x-data="{ caretRotate: 0, }" id="logo-sidebar"
        ...
        class="fixed top-0 left-0 z-40 hidden md:block md:w-20 xl:w-64 h-full duration-500 ease-in-out select-none"
        aria-label="Sidebar">

        {{-- Sidebar Opener Caret --}}
        <div :class="{
            '-right-3 hidden xl:block': open,
            '-right-4 hidden xl:block': !open,
        }"
        ...
        <div class="relative overflow-visible flex flex-col justify-between h-full px-3 w-full py-4 bg-indigo-900">
            <div class="flex flex-col gap-4">
                <img :class="{
                    'translate-x-0 opacity-100 xl:-translate-x-16 xl:opacity-0': open,
                ...
                <div :class="{
                    '-translate-x-32 opacity-0': !open,
                    '-translate-x-32 opacity-0 xl:translate-x-0 xl:opacity-100': open,
                }"
