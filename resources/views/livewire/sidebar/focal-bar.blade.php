<nav>
    ...
    <aside id="logo-sidebar"
        ...
        aria-label="Sidebar">
        <div class="relative h-full px-3 w-full py-4 overflow-y-auto bg-indigo-900">
            ...
            <div class="absolute left-0 bottom-0 w-full min-w-full flex items-center justify-center font-medium">
                ...
                <button id="profileTopButton" data-dropdown-toggle="profileTopDropdown"
                    class="flex w-full items-center justify-center py-2 text-indigo-50 hover:text-indigo-200 focus:text-indigo-200 hover:bg-indigo-1000 focus:outline-none focus:bg-indigo-1000 transition duration-75 ease-in-out group">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <li>
                            ...
                            <button type="submit" aria-label="{{ __('Logout') }}"
                                class="flex items-center w-full justify-start text-indigo-1100 px-4 py-2 hover:bg-gray-100 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                    class="size-6 pe-2">
                                    <path fill-rule="evenodd"
